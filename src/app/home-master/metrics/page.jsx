    ...
    <div className="min-h-screen bg-slate-900 p-4">
      ...
      <div className="mb-6">
          ...
          <div className="bg-slate-800 p-3 rounded-lg">
            ...
            <div className="text-white text-xl font-bold">
              {systemStats?.memory?.used
                ? `${Math.round(systemStats.memory.used / 1024 / 1024)}MB`
                : "N/A"}
            </div>
        ...
        {alerts.filter((a) => a.severity === "high").length > 0 && (
          <div className="mb-4">
            <Suspense
              fallback={<MetricsLoading message="Cargando alertas..." />}
            >
              <AlertsPanel
      ...
      <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-semibold">
                      {performanceStats.pageLoads.total}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Llamadas API:</span>
                    <span className="text-white font-semibold">
                      {performanceStats.apiCalls.total}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Tasa de cache:</span>
                    <span className="text-white font-semibold">
                      {performanceStats.cache.hitRate.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              {businessStats ? (
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-semibold">
                      {businessStats.orders.total}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Usuarios activos:</span>
                    <span className="text-white font-semibold">
                      {businessStats.users.active}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-semibold">
                      {businessStats.restaurants.active}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Items sin stock:</span>
                    <span className="text-white font-semibold">
                      {businessStats.inventory.outOfStock}
                    </span>
                  </div>
                </div>
              ) : (
        ...
        {activeTab === "performance" && (
          <Suspense
            fallback={
              <MetricsLoading message="Cargando dashboard de performance..." />
            }
          >
        ...
        {activeTab === "business" && (
          <Suspense
            fallback={
              <MetricsLoading message="Cargando dashboard de negocio..." />
            }
          >
        ...
        {activeTab === "system" && (
          <Suspense
            fallback={
              <MetricsLoading message="Cargando dashboard del sistema..." />
            }
          >
