        ...
        try {
          ...
          if (result?.success && result?.data) {
            ...
            setPaymentData({
              ...result.data,
              externalReference:
                result.externalReference || result.data.externalReference,
            });
            ...
            throw new Error(
              "No se pudieron obtener los datos de pago de Mercado Pago"
            );
          }
        } catch (paymentError) {
          console.error("❌ Error procesando pago Mercado Pago:", paymentError);
          alert(
            `Error al procesar el pago con Mercado Pago: ${paymentError.message}`
          );
          setIsProcessing(false);
          return;
        }
          ...
          <div className="p-6 border-b border-slate-700/50">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white font-medium">
                  {orderData?.productos?.length || 0} items
                </span>
              </div>
              ...
              <div className="space-y-4">
                ...
                {orderData?.mesa === "DELIVERY" && (
                  <p className="text-xs text-slate-400 text-center">
                    Para pedidos de delivery solo está disponible el link de
                    pago
                  </p>
                )}
              </div>
            ...
            <div className="mt-8">
              <button
                ...
                disabled={
                  ...
                  (paymentMethod === "mercadopago" && !mercadopagoOption)
                }
