...
function NuevoAgregarPedido({ mesa, onBack, onPedidoAgregado, onMesaActualizada }) {
  const {
    mainCategories,
    subCategories,
    products,
  ...
  const handleEnviarACocina = async () => {
    ...
    try {
      ...
      await updateDoc(mesaRef, {
        ...
        estado: "en_preparacion", // Cambiar a estado amarillo (en preparación)
        updatedAt: new Date(),
      });
      ...
      // Notificar al componente padre que la mesa se actualizó
      if (onMesaActualizada) {
        console.log("🔄 Notificando actualización de mesa al componente padre");
        onMesaActualizada();
      }
              ...
              {isInitialLoading || loading ? (
                ...
                <div className="col-span-full flex items-center justify-center py-12">
                  <div className="text-center">
                    ...
                    <p className="text-red-600 text-lg mb-2">Error al cargar productos</p>
