  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-slate-400 mb-4">Preparando módulo{dots}</p>
...
const LazyModule = ({
  ...
  return (
    <Suspense
      fallback={
        fallback || (
          <SmartLoading moduleName={moduleName} retryCount={retryCount} />
        )
      }
    >
      <ErrorBoundary onError={handleError}>{module}</ErrorBoundary>
    </Suspense>
  );
};
