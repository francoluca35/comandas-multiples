...
const cloudName =
  ...
  envVars.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME ||
  "diwlchtx1";
...
if (!envVars.CLOUDINARY_UPLOAD_PRESET) {
  console.log(
    "  ❌ Configura CLOUDINARY_UPLOAD_PRESET en tu archivo .env.local"
  );
}
if (!envVars.CLOUDINARY_API_KEY || !envVars.CLOUDINARY_API_SECRET) {
  console.log(
    "  ⚠️  Para funcionalidades avanzadas, configura API_KEY y API_SECRET"
  );
}
