          ...
          <div className="container mx-auto px-4 py-6">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-6 space-x-4">
                ...
                <button
                  onClick={() => {
                    console.log("🔍 DEBUG: Estado actual de pedidos:", pedidos);
                    console.log("🔍 DEBUG: Pedidos primeros:", pedidosPrimeros);
                    console.log("🔍 DEBUG: Pedidos hechos:", pedidosHechos);
                ...
                <button
                  onClick={async () => {
                    try {
                      ...
                      console.log("🧪 Creando pedido de prueba para restaurante:", restauranteId);
                      
                      const testOrder = {
                        mesa: "1",
                        productos: [
                          { nombre: "Hamburguesa", cantidad: 1, precio: 10000, total: 10000 }
                        ],
                        total: 10000,
                      ...
                      const response = await fetch("/api/pedidos-cocina", {
                        ...
                        body: JSON.stringify({ restauranteId, ...testOrder })
                      });
                      ...
                      if (response.ok) {
                        ...
                        console.error("❌ Error creando pedido de prueba");
                      }
                    } catch (error) {
