...
const PedidoCard = ({ pedido, onStatusChange, tipo }) => {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-5 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]">
      {/* Header del pedido */}
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          <div className={`p-2 rounded-full ${tipo === "primeros" ? "bg-orange-100" : "bg-green-100"}`}>
            <svg className={`w-4 h-4 ${tipo === "primeros" ? "text-orange-600" : "text-green-600"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex justify-end">
        {tipo === "primeros" ? (
          <button
            ...
            className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-2.5 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center space-x-2"
          >
