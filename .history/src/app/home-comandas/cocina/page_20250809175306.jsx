...
const PedidoCard = ({ pedido, onStatusChange, tipo }) => {
  ...
  if (isVacio) {
    return (
      <div className="bg-gray-100 rounded-lg p-4 h-24 flex items-center justify-center border border-gray-300">
  ...
  return (
    <div className="bg-gray-100 rounded-lg p-4 h-24 flex items-center justify-between shadow-sm border border-gray-300">
      ...
      <div className="flex-1">
        ...
        <div className="space-y-1">
          {pedido.productos?.slice(0, 4).map((item, index) => (
            <div key={index} className="flex items-center text-sm text-gray-700">
              <span className="font-medium text-gray-800 mr-2">×{item.cantidad}</span>
          ...
          {pedido.productos?.length > 4 && (
            <div className="text-xs text-gray-500">+{pedido.productos.length - 4} más...</div>
          )}
        </div>
      </div>
      ...
      <div className="ml-4">
        {tipo === "primeros" ? (
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 px-4 rounded-md transition-colors duration-200"
          >
            Listo
          </button>
        ) : (
          <button
            ...
            className="bg-red-500 hover:bg-red-600 text-white text-sm font-medium py-2 px-4 rounded-md transition-colors duration-200"
          >
            Realizado
          </button>
        )}
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
          <div className="container mx-auto px-4 py-6">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-6 text-center text-slate-300 bg-slate-800/30 rounded-lg p-4 border border-slate-700">
                <p className="text-sm">
