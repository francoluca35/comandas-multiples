    ...
    try {
      if (user && restaurant) {
        ...
        if (isFirstTimeUser || !hasMercadoPago) {
          setNeedsSetup(true);
          // Redirigir automáticamente a configuración
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-800 rounded-lg shadow-lg border border-slate-700/50 p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">¡Bienvenido!</h3>
                </div>
                <p className="text-slate-300 text-sm">
                  Tu restaurante está configurado y listo para recibir pedidos y pagos con tarjeta.
                </p>
              </div>
              ...
              <div className="bg-slate-800 rounded-lg shadow-lg border border-slate-700/50 p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">Tu Restaurante</h3>
                </div>
                <div className="space-y-2 text-sm">
                  <div>
                    <span className="text-slate-400">Nombre:</span>
                    <span className="text-white ml-2">{restaurant?.nombre}</span>
                  </div>
                  <div>
