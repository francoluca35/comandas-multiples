    ...
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="w-16 bg-gray-800 flex flex-col items-center py-4 space-y-6">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          {/* Shopping Cart */}
          <div className="w-10 h-10 flex items-center justify-center text-gray-400 hover:text-white cursor-pointer">
        ...
        {/* Logout */}
        <div className="mt-auto w-10 h-10 flex items-center justify-center text-gray-400 hover:text-white cursor-pointer">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg p-6 text-white">
            ...
            <p className="text-sm mb-6 opacity-90">
              Sin estrés ni riesgos, sin cablerío ni configuración, sin manuales ni complicaciones. 
              Cambió el paradigma: manejá tu negocio con sólo dos taps!
            </p>
