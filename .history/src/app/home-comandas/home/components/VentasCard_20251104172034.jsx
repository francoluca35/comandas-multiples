    ...
    try {
      ...
      if (dias && dias.length > 0) {
        ...
        dias.forEach((d) => {
          ...
          const fechaVal = (() => {
            if (!d || d.fecha === undefined || d.fecha === null) return d.id || "";
            const f = d.fecha;
          ...
          filas.push({ "Tipo de Venta": "Salón", Fecha: fechaVal, Cantidad: d.salon || 0 });
          filas.push({ "Tipo de Venta": "Takeaway", Fecha: fechaVal, Cantidad: d.takeaway || 0 });
          filas.push({ "Tipo de Venta": "Delivery", Fecha: fechaVal, Cantidad: d.delivery || 0 });
        });
