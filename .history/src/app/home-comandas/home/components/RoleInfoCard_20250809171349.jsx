...
const RoleInfoCard = () => {
  ...
  return (
    <div
      className={`bg-slate-800/50 backdrop-blur-sm border ${getRoleBorderColor()} rounded-xl p-4 shadow-lg`}
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <div
          className={`px-2 py-1 rounded-full text-xs font-medium ${getRoleBgColor()} ${getRoleColor()}`}
        >
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <p className="text-slate-200 text-sm">{getRoleDescription()}</p>
        </div>
