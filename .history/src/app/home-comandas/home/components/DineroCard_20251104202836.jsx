  ...
  return (
    <div className="bg-[#2a2a2a] rounded-lg p-4 sm:p-6 text-white h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
        {/* Ingreso Efectivo */}
        <div className="bg-green-600 rounded-lg p-3 min-w-0">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between min-w-0">
            ...
            <div className="mt-2 lg:mt-0">
              <span className="text-sm sm:text-base font-bold text-right whitespace-nowrap block">
        ...
        {/* Ingreso Virtual */}
        <div className="bg-blue-600 rounded-lg p-3 min-w-0">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between min-w-0">
            <div className="flex items-start lg:items-center">
              <svg
                className="w-4 h-4 text-white mr-2"
        ...
        {/* Egreso Efectivo */}
        <div className="bg-red-600 rounded-lg p-3 min-w-0">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between min-w-0">
            <div className="flex items-start lg:items-center">
              <svg
                className="w-4 h-4 text-white mr-2"
        ...
        {/* Egreso Virtual */}
        <div className="bg-orange-600 rounded-lg p-3 min-w-0">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between min-w-0">
            <div className="flex items-start lg:items-center">
              <svg
                className="w-4 h-4 text-white mr-2"
