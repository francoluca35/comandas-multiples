...
function Sidebar() {
  ...
  return (
    <div
      className={`${
        isExpanded ? "w-64" : "w-20 h-10"
      } bg-slate-900/80 backdrop-blur-sm border-r border-slate-700/50 flex flex-col items-center py-6 space-y-4 transition-all duration-300 ease-in-out shadow-2xl shadow-slate-900/50`}
    >
      {/* Hamburger Menu */}
      <div
        className="text-slate-300 hover:text-white cursor-pointer p-2 rounded-lg hover:bg-slate-700/30 transition-all duration-300 mb-4"
