  ...
  const handleDescargarInforme = async () => {
    try {
      ...
      const datosExcel = historial.map((registro) => {
        const fecha =
          registro.timestamp instanceof Date
            ? registro.timestamp
            : registro.fecha
        ...
        return {
          Usuario:
            registro.usuarioNombre || registro.usuarioEmail || "Desconocido",
          Email: registro.usuarioEmail || "",
          UsuarioId: registro.usuarioId || "",
          Rol: registro.rol || "",
          Fecha: fecha.toLocaleDateString("es-ES"),
          HoraApertura: registro.horaApertura
            ? registro.horaApertura instanceof Date
              ? registro.horaApertura.toLocaleTimeString("es-ES")
              : new Date(registro.horaApertura).toLocaleTimeString("es-ES")
            : "",
          HoraCierre: registro.horaCierre
            ? registro.horaCierre instanceof Date
              ? registro.horaCierre.toLocaleTimeString("es-ES")
              : new Date(registro.horaCierre).toLocaleTimeString("es-ES")
            : "",
        };
      });
