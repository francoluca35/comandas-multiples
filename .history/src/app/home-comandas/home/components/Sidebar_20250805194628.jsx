...
function Sidebar() {
  ...
  return (
    <div
      className={`${
        isExpanded
          ? "w-50 sm:w-64 md:w-72 lg:w-80 xl:w-96 2xl:w-[420px]"
          : "w-16 sm:w-20"
      } bg-slate-900/80 backdrop-blur-sm border-r border-slate-700/50 flex flex-col items-center py-3 sm:py-4 md:py-6 space-y-2 sm:space-y-3 md:space-y-4 transition-all duration-300 ease-in-out shadow-2xl shadow-slate-900/50 h-screen max-h-screen overflow-hidden z-20 relative`}
    >
