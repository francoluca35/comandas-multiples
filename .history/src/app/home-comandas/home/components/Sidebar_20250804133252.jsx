    ...
    >
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <div
          ...
          onClick={() => handleItemClick("productos", "/home-comandas/productos")}
        >
          <svg
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "inventario" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "promociones" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "exportar" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
