...
function Sidebar() {
  ...
  const handleLogoClick = () => {
    if (isExpanded) {
      // Si el sidebar está abierto, ir a la página de usuarios y cerrar sesión
    ...
    >
      ...
      >
        <CloudinaryImage
          ...
          alt="Foto de perfil"
          size={35}
          className={isExpanded ? "w-24 h-24" : "w-14 h-14"}
      ...
      {/* Logout */}
      <div className={`${getItemClasses("logout")}`} onClick={handleLogout}>
        <svg
