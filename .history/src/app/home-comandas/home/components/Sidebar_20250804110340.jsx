...
function Sidebar() {
  ...
  useEffect(() => {
    if (pathname === "/home-comandas/home" || pathname === "/home-comandas") {
      ...
      setActiveItem("home"); // Default to home
    }
  }, [pathname]);
    ...
    >
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "home" ? "text-white" : ""}`}>
              Inicio
            </span>
          )}
        </div>
        ...
        >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "mesas" ? "text-white" : ""}`}>
              Mesas
            </span>
          )}
        </div>
        ...
        >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "ventas" ? "text-white" : ""}`}>
              Ventas
            </span>
          )}
        </div>
        ...
        >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "pagos" ? "text-white" : ""}`}>
              Pagos
            </span>
          )}
        </div>
        ...
        >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "stock" ? "text-white" : ""}`}>
              Stock
            </span>
          )}
        </div>
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "reportes" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "reportes" ? "text-white" : ""}`}>
              Reportes
            </span>
          )}
        </div>
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "productos" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "productos" ? "text-white" : ""}`}>
              Productos
            </span>
          )}
        </div>
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "configuracion" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "configuracion" ? "text-white" : ""}`}>
              Configuración
            </span>
          )}
        </div>
        ...
        >
          <svg
            className={`w-5 h-5 ${activeItem === "filtros" ? "text-white" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {isExpanded && (
            <span className={`ml-3 font-medium ${activeItem === "filtros" ? "text-white" : ""}`}>
              Filtros
            </span>
          )}
        </div>
      ...
      >
        ...
        {isExpanded && (
          <span className={`ml-3 font-medium ${activeItem === "logout" ? "text-white" : ""}`}>
            Cerrar Sesión
          </span>
        )}
      </div>
