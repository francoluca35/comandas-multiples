    ...
    <div
      className={`${
        isExpanded
          ...
          : "w-16 sm:w-20"
      } fixed left-0 top-0 bg-slate-900/80 backdrop-blur-sm border-r border-slate-700/50 flex flex-col items-center py-3 sm:py-4 md:py-6 space-y-2 sm:space-y-3 md:space-y-4 transition-all duration-300 ease-in-out shadow-2xl shadow-slate-900/50 h-screen max-h-screen overflow-hidden z-20`}
    >
