    ...
    <div
      className={`${
        isExpanded
          ...
          : "w-16 sm:w-20"
      } fixed left-0 top-0 bg-slate-900/95 border-r border-slate-700/50 flex flex-col items-center py-2 sm:py-3 md:py-4 lg:py-6 space-y-1 sm:space-y-2 md:space-y-3 lg:space-y-4 transition-all duration-300 ease-in-out shadow-2xl shadow-slate-900/50 h-screen max-h-screen overflow-hidden z-20`}
    >
