...
function Sidebar() {
  ...
  const getItemClasses = (itemId) => {
    ...
    if (isActive) {
      return `${baseClasses} bg-gradient-to-r from-blue-600/20 to-blue-700/20 border border-blue-500/30 rounded-lg sm:rounded-xl shadow-lg shadow-blue-500/25`;
    } else {
      return `${baseClasses} text-slate-400 hover:text-white hover:bg-slate-700/30 rounded-lg sm:rounded-xl border border-transparent hover:border-slate-600/30 transition-all duration-300`;
    }
  };
