...
function TurnoCard() {
  ...
  if (loading) {
    return (
      <div className="bg-[#2a2a2a] rounded-xl p-4 text-white shadow-2xl h-full flex flex-col">
  ...
  if (turnoAbierto) {
    ...
    return (
             <div className="bg-[#2a2a2a] rounded-lg p-4 text-white h-full flex flex-col">
