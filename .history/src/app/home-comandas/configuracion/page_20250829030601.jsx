...
const SoundConfiguration = () => {
  ...
  const soundOptions = [
    ...
    },
    {
      id: "alarm",
      name: "WhatsApp",
      description: "Sonido de notificación característico de WhatsApp",
      icon: "💬",
    ...
    },
    {
      ...
      description: "Sube tu propio archivo de audio (MP3, WAV, etc.)",
      icon: "📁",
  ...
  const handleFileUpload = async (file) => {
    setSaving(true);
    try {
      const success = await handleCustomAudioFile(file);
      if (success) {
        setSelectedSound("custom");
        alert(`✅ Archivo cargado y guardado: ${file.name}`);
      } else {
        alert("❌ Error al cargar el archivo. Verifica que sea un archivo de audio válido.");
      }
    } catch (error) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      ...
                      {sound.id === "custom" && customAudioFile && (
                ...
                <button
                  ...
                  disabled={isPlaying || (sound.id === "custom" && !customAudioFile) || saving}
      ...
      {/* Área de subida de archivo personalizado */}
      {selectedSound === "custom" && (
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Subir Archivo de Audio</h3>
          ...
          >
            {customAudioFile ? (
              <div className="space-y-3">
                ...
                <div>
                  <p className="font-medium text-gray-800">{customAudioFile.name}</p>
                ...
                <div className="flex justify-center space-x-2">
                  ...
                  >
                    {isPlaying ? <FaStop className="w-4 h-4" /> : <FaPlay className="w-4 h-4" />}
                    {isPlaying ? ' Reproduciendo...' : ' Probar'}
                  </button>
                  <button
                    onClick={() => {
                      setCustomAudioFile(null);
                      setCustomAudioUrl(null);
                      setSelectedSound("powerful");
                    }}
                    disabled={saving}
                    className={`px-4 py-2 rounded-lg font-medium bg-red-500 hover:bg-red-600 text-white transition-all duration-200 ${saving ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
                    Eliminar
                  </button>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="font-medium text-gray-800">Arrastra tu archivo de audio aquí</p>
                ...
                <label
                  ...
                  className={`inline-block px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg font-medium cursor-pointer transition-all duration-200 ${saving ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                  Seleccionar Archivo
                </label>
              </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          disabled={selectedSound === soundType || (selectedSound === "custom" && !customAudioFile) || saving}
          className={`px-8 py-3 rounded-xl font-semibold transition-all duration-200 ${
            selectedSound === soundType || (selectedSound === "custom" && !customAudioFile) || saving
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700">
              ...
              Para archivos personalizados, asegúrate de que sean archivos de audio válidos y no muy pesados.
            </p>
          </div>
        </div>
      </div>
