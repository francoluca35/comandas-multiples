    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  disabled={isPlaying || (sound.id === "custom" && !customAudioFile)}
            ...
            {customAudioFile ? (
              ...
              <div className="space-y-3">
                ...
                <label
                  ...
                  className="inline-block px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg font-medium cursor-pointer transition-all duration-200"
                >
                  Seleccionar Archivo
                </label>
              </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          disabled={selectedSound === soundType || (selectedSound === "custom" && !customAudioFile)}
          className={`px-8 py-3 rounded-xl font-semibold transition-all duration-200 ${
            selectedSound === soundType || (selectedSound === "custom" && !customAudioFile)
