                        ...
                        <div>
                          ...
                          {mpConfig && (
                            <div className="mt-2 text-xs text-green-200">
                              <p>Tipo de cuenta: {mpConfig.accountType === 'sandbox' ? 'Sandbox (Pruebas)' : 'Producción'}</p>
                              {mpConfig.lastValidated && (
                                <p>Última validación: {new Date(mpConfig.lastValidated.toDate()).toLocaleDateString()}</p>
                              )}
                            </div>
                          )}
                        </div>
