          ...
          <div className="max-w-4xl mx-auto px-6 py-6">
            ...
            {isFirstTime && (
              <div className="mb-6 bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="text-blue-300 font-semibold">Configuración Inicial</h3>
                    <p className="text-blue-200 text-sm">
                      Completa estos pasos para configurar tu restaurante y comenzar a usar la aplicación.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  {mercadopagoConfig.isConfigured ? (
                    <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-green-300 font-medium">Mercado Pago Configurado</h4>
                          <p className="text-green-200 text-sm">Tu cuenta está conectada y lista para recibir pagos.</p>
                        </div>
                      </div>
                    </div>
                  ) : (
            ...
            {isFirstTime && mercadopagoConfig.isConfigured && (
              <div className="mt-8 text-center">
                ...
                >
                  {configComplete ? "¡Configuración Completada!" : "Completar Configuración"}
                </button>
                {configComplete && (
            ...
            {isFirstTime && !mercadopagoConfig.isConfigured && (
              <div className="mt-8 bg-slate-800 rounded-lg border border-slate-700/50 p-6">
                <h3 className="text-lg font-semibold text-white mb-4">📋 Guía de Configuración de Mercado Pago</h3>
                <div className="space-y-3 text-slate-300">
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-2">1.</span>
                    <p>Ve a <a href="https://www.mercadopago.com.ar/developers" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Mercado Pago Developers</a></p>
                  </div>
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-2">2.</span>
                    <p>Crea una cuenta o inicia sesión en tu cuenta existente</p>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <p>Copia el "Access Token" y "Public Key" de tu aplicación</p>
                  </div>
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-2">5.</span>
                    <p>Pega las credenciales en los campos de arriba y guarda</p>
                  </div>
                </div>
              </div>
            )}
