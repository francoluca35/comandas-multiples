...
function ConfiguracionContent() {
  ...
  const checkFirstTimeSetup = async () => {
    try {
      if (user && restaurant && restaurant.id) {
  ...
  const handleMercadoPagoConfig = async () => {
    ...
    try {
      ...
      // Validar que restaurant esté disponible
      if (!restaurant || !restaurant.id) {
        alert("Error: No se pudo obtener la información del restaurante. Intenta recargar la página.");
        return;
      }
