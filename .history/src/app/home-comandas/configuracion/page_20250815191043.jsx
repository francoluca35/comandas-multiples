...
function ConfiguracionContent() {
  ...
  const handleMercadoPagoConfig = async () => {
    ...
    try {
      ...
      if (!mercadopagoConfig.accessToken || !mercadopagoConfig.publicKey || !mercadopagoConfig.webhookSecret) {
        alert("Por favor completa todos los campos de Mercado Pago (Access Token, Public Key y Webhook Secret)");
        return;
      }
