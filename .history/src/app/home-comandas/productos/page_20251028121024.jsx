...
function ProductosContent() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    if (currentView === "menu") {
      // Solo productos del menú (platos, postres) - NO materia prima, NO bebidas
        ...
        <div className="flex-1 p-4 sm:p-6">
          <div className="mb-4">
            <p className="text-slate-400 text-sm">
              {currentView === "menu" 
                ? "Productos que aparecen en el menú del restaurante (platos, postres)" 
