...
import ProductBarcodeManager from "../../../components/ProductBarcodeManager";
import Sidebar, {
  useSidebar,
  SidebarProvider,
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="bg-orange-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center justify-center sm:justify-start space-x-2 hover:bg-orange-700 text-sm sm:text-base"
              >
