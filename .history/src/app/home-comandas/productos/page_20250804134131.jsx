...
function ProductosPage() {
  ...
  useEffect(() => {
    if (subCategories[selectedMainCategory] && subCategories[selectedMainCategory].length > 0 && !selectedSubCategory) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingProduct) {
        await updateProduct(editingProduct.id, formData.mainCategoryId, formData.subCategoryId, formData);
      } else {
  ...
  const handleSubCategorySubmit = async (e) => {
    ...
    try {
      await createSubCategory(subCategoryFormData.mainCategoryId, subCategoryFormData.name);
  ...
  const handleDelete = async (product) => {
    if (
      ...
      try {
        await deleteProduct(product.id, product.mainCategoryId, product.subCategoryId);
      } catch (err) {
    ...
    <div className="flex h-screen bg-gray-900">
              ...
              {formData.mainCategoryId && (
                <div>
                  ...
                  >
                    ...
                    {subCategories[formData.mainCategoryId]?.map((subCategory) => (
                      <option key={subCategory.id} value={subCategory.id}>
                        {subCategory.name}
                      </option>
                    ))}
      ...
      {showMainCategoryForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-white">Nueva Categoría Principal</h2>
              <button
      ...
      {showSubCategoryForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-white">Nueva Subcategoría</h2>
              <button
