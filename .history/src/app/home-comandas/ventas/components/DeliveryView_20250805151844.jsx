    ...
    <div className="h-full bg-slate-900 flex">
      ...
      <div className="w-1/2 bg-slate-800 flex flex-col">
        ...
        <div className="flex-1 p-6 flex flex-col">
          ...
          {showOrderDetails && selectedProducts.length > 0 && (
          ...
          {selectedProducts.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-lg">No hay productos seleccionados</p>
                <p className="text-gray-500 text-sm mt-2">Selecciona productos del menú</p>
              </div>
            </div>
          ) : (
              ...
              <div className="bg-slate-700 rounded-lg p-4 mb-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-white font-semibold">{getTotalItems()}</p>
                  </div>
