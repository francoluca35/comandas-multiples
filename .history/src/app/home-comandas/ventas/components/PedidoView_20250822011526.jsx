  ...
  return (
    <div className="h-screen max-h-screen min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden min-h-0">
        ...
        {/* Panel de Items del Pedido - Nuevo */}
        <div className="w-full lg:w-1/3 bg-gradient-to-br from-slate-700 to-slate-800 lg:border-r border-slate-600/50 overflow-y-auto">
          <div className="p-2 sm:p-3 md:p-4">
            <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4 flex items-center space-x-2">
            ...
            {orderItems.length === 0 ? (
              <div className="text-center py-8">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-slate-600 to-slate-700 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-xl">
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                  </svg>
                </div>
                <h4 className="text-white text-sm sm:text-base font-bold mb-1 sm:mb-2">
                  No hay items
                </h4>
                <p className="text-slate-400 text-xs sm:text-sm">
              ...
              <div className="space-y-2 sm:space-y-3">
                {orderItems.map((item, index) => (
                  <div
                    key={item.id}
                    className="bg-gradient-to-r from-slate-600 to-slate-700 rounded-lg p-2 sm:p-3 border border-slate-500/50 hover:border-slate-400/50 transition-all duration-200 shadow-lg"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          className="w-6 h-6 sm:w-7 sm:h-7 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center transition-all duration-200 shadow-lg"
                        >
                          <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
