...
function PedidoView({ mesa, onBack, onMesaOcupada }) {
  ...
  const handleTerminar = () => {
    // Marcar la mesa como ocupada y volver a la vista de mesas
    console.log(`Marcando mesa ${mesa.numero} como ocupada`);
    onMesaOcupada(mesa.numero);
    onBack();
  };
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="bg-green-500 text-white rounded-lg px-3 py-2 flex items-center space-x-2"
            >
              {getIcon("check")}
              <span>Terminar</span>
            </button>
