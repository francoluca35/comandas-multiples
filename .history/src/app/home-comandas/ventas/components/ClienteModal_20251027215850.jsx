...
function ClienteModal({ isOpen, onClose, onSave, mesa }) {
  ...
  // Efecto adicional para actualizar cuando cambien los datos del cliente
  useEffect(() => {
    if (isOpen && mesa && mesa.datos_cliente) {
      console.log("🔄 Actualizando datos del cliente:", mesa.datos_cliente);
      setClienteData({
        nombre: mesa.datos_cliente.nombre || "",
        email: mesa.datos_cliente.email || "",
        whatsapp: mesa.datos_cliente.whatsapp || "",
  ...
  console.log("🎯 Datos actuales en el modal:", clienteData);
