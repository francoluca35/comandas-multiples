          ...
          {selectedProduct ? (
            <div className="h-full flex flex-col p-2 sm:p-3 md:p-4">
              ...
              <div className="space-y-3">
                ...
                {/* Botón Finalizar Pedido - Solo cuando hay items */}
                {orderItems.length > 0 && (
                  <button
                    onClick={handleFinalizarPedido}
                    className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl px-3 py-2 sm:px-4 sm:py-3 flex items-center justify-center space-x-2 font-bold text-sm sm:text-base transition-all duration-200 transform hover:scale-105 shadow-xl"
                  >
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
