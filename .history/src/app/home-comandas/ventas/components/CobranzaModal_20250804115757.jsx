      ...
      <div className="bg-gray-800 rounded-lg p-6 w-96 max-h-[80vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="bg-gray-700 rounded-lg p-3 text-center">
            ...
            <div className="text-white font-bold">{orderData?.mesa || "002"}</div>
          </div>
          ...
          <div className="bg-gray-700 rounded-lg p-3 text-center">
            ...
            <div className="text-white font-bold">{orderData?.proforma || "003"}</div>
          </div>
          ...
          <div className="bg-gray-700 rounded-lg p-3 text-center">
            ...
            <div className="text-white font-bold">$ {orderData?.monto || "100"}</div>
          </div>
        </div>
        ...
        {showPaymentMethods && (
          <div className="mb-6">
            <div className="text-white text-sm mb-3">Seleccionar método de pago:</div>
