...
function PedidoView({ mesa, onBack, onPedidoEnviado }) {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-100">
      ...
      <div className="bg-red-600 p-2 flex items-center justify-center space-x-4">
        <button
      ...
      {/* Barra fija abajo */}
      <div className="fixed bottom-0 left-0 right-0 bg-blue-700 border-t border-blue-600 p-4 z-20">
