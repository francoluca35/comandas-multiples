          ...
          <div key={mesa.id} className="relative group">
            <button
              ...
              className={`${getStatusColor(
                mesa.estado
              )} text-white rounded-xl p-4 sm:p-5 lg:p-6 text-center transition-all duration-300 transform hover:scale-105 w-full h-full min-h-[100px] sm:min-h-[120px] lg:min-h-[140px] shadow-lg hover:shadow-xl`}
            >
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3">{mesa.numero}</div>
              ...
              {mesa.cliente && (
                <div className="text-xs sm:text-sm opacity-75 mt-1 sm:mt-2 truncate">
                  Cliente: {mesa.cliente}
                </div>
              )}
              {mesa.total > 0 && (
                <div className="text-xs sm:text-sm opacity-75 mt-1 sm:mt-2 font-semibold">
                  Total: ${mesa.total}
                </div>
              )}
            </button>
