          ...
          <div key={mesa.id} className="relative group">
            ...
            {mesa.estado === "ocupado" && (
              <button
                ...
                className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-red-600 hover:bg-red-700 text-white text-xs px-1 sm:px-2 py-1 rounded-full transition-all duration-200 transform hover:scale-110 shadow-lg z-10"
            ...
            {mesa.estado === "pagado" && (
              <button
                ...
                className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-green-600 hover:bg-green-700 text-white text-xs px-1 sm:px-2 py-1 rounded-full transition-all duration-200 transform hover:scale-110 shadow-lg z-10"
                title="Liberar Mesa"
              >
                <svg
                  className="w-2 h-2 sm:w-3 sm:h-3"
