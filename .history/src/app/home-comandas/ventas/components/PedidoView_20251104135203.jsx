  ...
  <div className="flex-1 p-2 overflow-y-auto">
    {loading ? (
      ...
      <div className="flex items-center justify-center h-full">
       ...
       {/* Barra de Resumen - (desktop) ocultar en mobile; mobile tiene footer separado */}
       <div className="hidden sm:flex flex-shrink-0 bg-gradient-to-r from-slate-800 to-slate-700 border-t border-slate-600/50 shadow-xl">
      ...
      {/* Footer móvil fijo con total + botones (aparece sólo en mobile) */}
      {orderItems.length > 0 && (
        <div className="sm:hidden fixed inset-x-0 bottom-0 z-50 bg-[#081226] border-t border-white/10 p-3">
          <div className="flex items-center justify-between gap-3">
            <div className="flex flex-col">
              <div className="text-white text-xs">Total del pedido</div>
              <div className="text-white font-bold text-lg">$ {orderTotal ? orderTotal.toLocaleString() : '0'}</div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleTerminar}
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg font-bold"
              >
                Enviar a Cocina
              </button>
            </div>
