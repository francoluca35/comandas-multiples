...
function MesasView({ onMesaClick }) {
  ...
  return (
    <div className="h-full bg-gray-900 p-3 sm:p-4 md:p-6">
      {/* Botonera de ubicación en el centro */}
      <div className="flex justify-center mb-4 sm:mb-6">
        <div className="bg-gray-800 rounded-lg p-1 flex">
          <button
            onClick={() => setLocationFilter("todas")}
            className={`px-3 sm:px-4 md:px-6 py-2 rounded-md text-xs sm:text-sm font-medium transition-all duration-200 ${
          ...
          <div key={mesa.id} className="relative">
            <button
              ...
              className={`${getStatusColor(
                mesa.estado
              )} text-white rounded-lg p-3 sm:p-4 md:p-6 text-center transition-all duration-200 transform hover:scale-105 w-full h-full min-h-[80px] sm:min-h-[100px] md:min-h-[120px]`}
            >
              <div className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2">{mesa.numero}</div>
