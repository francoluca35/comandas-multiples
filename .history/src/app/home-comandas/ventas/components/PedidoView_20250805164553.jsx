    ...
    <div className="h-full flex flex-col bg-gray-900">
      ...
      {orderItems.length > 0 && (
        <div className="bg-gray-800 border-t border-gray-700">
          ...
          <div
            className={`px-4 sm:px-6 pb-4 sm:pb-6 transition-all duration-500 ease-in-out overflow-hidden ${
              showOrderDetails
                ? "max-h-[800px] opacity-100"
                : "max-h-0 opacity-0 pb-0"
            }`}
          >
            <div className="bg-gray-700 rounded-lg overflow-hidden shadow-lg transform transition-all duration-500 ease-in-out">
              <div className="max-h-none overflow-y-auto">
                <div className="divide-y divide-gray-600">
                  {orderItems.map((item, index) => (
                    <div
                      key={item.id}
                      className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 hover:bg-gray-600/50 transition-colors duration-200"
                    >
