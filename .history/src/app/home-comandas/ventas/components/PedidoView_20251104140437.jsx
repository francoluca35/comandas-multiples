            ...
            {orderItems.length > 0 && (
              <div className="mt-auto space-y-2">
                <div className="flex gap-2">
                  <button
                    onClick={() => setShowOrderDetails(true)}
                    className="flex-1 bg-[#D98C00] hover:bg-[#C77A00] text-white rounded-xl px-4 py-3 font-bold transition-all"
                  >
                    ver items
                  </button>
                  <button
                    onClick={handleTerminar}
                    className="flex-1 bg-[#00A884] hover:bg-[#009673] text-white rounded-xl px-4 py-3 font-bold transition-all"
                  >
                    enviar a cocina
                  </button>
                </div>
