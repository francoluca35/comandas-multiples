...
import TakeawayCashPaymentModal from "./TakeawayCashPaymentModal";
...
function TakeawayPaymentModal({ isOpen, onClose, orderData, onPaymentComplete }) {
  ...
  const handleProcessPayment = async () => {
    ...
    if (selectedPaymentMethod === "efectivo") {
      ...
      console.log("🚀 Procesando pago takeaway MercadoPago:", {
  ...
  const handlePaymentSuccess = async (method) => {
    try {
      console.log("✅ Pago exitoso, preparando envío de ticket...");
