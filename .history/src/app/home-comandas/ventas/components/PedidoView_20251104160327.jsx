...
function PedidoView({ mesa, onBack, onPedidoEnviado }) {
  ...
  const ProductCard = React.memo(
    ({ product, expanded, productQuantity, onSelect, onAdd }) => {
      if (expanded) {
        return (
          <div className="bg-blue-600 rounded-lg p-4 border-2 border-blue-400">
            ...
            <div className="text-white text-xs mb-3">
              $
              {(product.precio * (1 - (product.descuento || 0) / 100)).toFixed(
                2
              )}
            </div>
            <button
      ...
      return (
        <div
          onClick={onSelect}
          className="bg-gray-700 rounded-lg p-4 cursor-pointer hover:border-2 hover:border-blue-500 transition-all min-h-[100px]"
        >
              ...
              <div ref={productsContainerRef} style={{ height: "100%" }}>
                ...
                >
                  {({ index, style }) => {
                    ...
                    const rowItems = filteredProducts.slice(
                      start,
                      start + columnCount
                    );
                    return (
