...
function MesasView({ onMesaClick }) {
  ...
  const [viewMode, setViewMode] = useState("grid"); // "grid" o "croquis"
    ...
    <div className="h-full bg-[#1a1a1a] p-3 sm:p-4 md:p-6 lg:p-8 max-w-full overflow-hidden">
      ...
      {viewMode === "grid" ? (
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-2 sm:gap-3 md:gap-4 lg:gap-6 max-w-full">
              ...
              <div key={mesa.id} className="relative group">
                <button
                  ...
                  className={`${getStatusColor(
                    mesa.estado
                  )} text-white rounded-xl p-3 sm:p-4 md:p-5 lg:p-6 text-center transition-all duration-300 transform hover:scale-105 w-full h-full min-h-[80px] sm:min-h-[100px] md:min-h-[120px] lg:min-h-[140px] shadow-lg hover:shadow-xl border-2 border-transparent hover:border-white/20`}
                >
                  <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2 md:mb-3 drop-shadow-lg">{mesa.numero}</div>
                  <div className="text-xs sm:text-sm md:text-base lg:text-lg opacity-90 font-medium drop-shadow-md">
                ...
                {mesa.estado === "ocupado" && (
                  <button
                    ...
                    className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 bg-red-600 hover:bg-red-700 text-white text-xs px-2 sm:px-3 py-1 sm:py-2 rounded-full transition-all duration-200 transform hover:scale-110 shadow-xl z-10 border-2 border-white"
                ...
                {mesa.estado === "pagado" && (
                  <button
                    ...
                    className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 bg-green-600 hover:bg-green-700 text-white text-xs px-2 sm:px-3 py-1 sm:py-2 rounded-full transition-all duration-200 transform hover:scale-110 shadow-xl z-10 border-2 border-white"
                    title="Liberar Mesa"
                  >
                    <svg
                      className="w-3 h-3 sm:w-4 sm:h-4"
        ...
        <MesasCroquisView onMesaClick={onMesaClick} />
      )}
    </div>
  );
}
