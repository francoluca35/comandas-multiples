...
function NavigationBar({
  ...
  return (
    <div className="bg-[#2a2a2a] p-2 sm:p-3 md:p-4 flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
      <div className="flex items-center space-x-1 sm:space-x-2">
        ...
        {modes.map((mode) => (
          <button
            ...
            className={`px-2 sm:px-3 md:px-4 py-1 sm:py-2 rounded-lg flex items-center space-x-1 sm:space-x-2 transition-colors ${
              activeMode === mode.id
          ...
          >
            ...
            <span className="font-medium text-xs sm:text-sm md:text-base">{mode.name}</span>
          </button>
        ))}
      </div>
      ...
      <div className="flex items-center space-x-1 sm:space-x-2">
        ...
        {currentActions.map((action) => (
          <button
            ...
            className="px-2 sm:px-3 md:px-4 py-1 sm:py-2 rounded-lg bg-gray-700 text-white hover:bg-gray-600 transition-colors flex items-center space-x-1 sm:space-x-2"
          >
            <div className="w-4 h-4 sm:w-5 sm:h-5">
              {getIcon(action.icon)}
            </div>
            {action.name && <span className="text-xs sm:text-sm md:text-base">{action.name}</span>}
          </button>
        ))}
      </div>
    </div>
