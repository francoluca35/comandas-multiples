...
import { FaTachometerAlt, FaClock, FaDatabase, FaNetworkWired } from 'react-icons/fa';
  ...
  return (
    <div className="bg-slate-700 rounded-lg p-4">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-slate-800 p-3 rounded-lg">
          <h4 className="text-sm font-semibold text-white mb-2">Desglose de Datos</h4>
        ...
        <div className="bg-slate-800 p-3 rounded-lg">
          <h4 className="text-sm font-semibold text-white mb-2">Estado del Sistema</h4>
          <div className="space-y-1 text-xs">
            <div className="flex justify-between">
              <span className="text-slate-400">Cache:</span>
              <span className={`${cacheHitRate > 80 ? 'text-green-400' : cacheHitRate > 50 ? 'text-yellow-400' : 'text-red-400'}`}>
                {cacheHitRate > 80 ? 'Excelente' : cacheHitRate > 50 ? 'Bueno' : 'Necesita mejora'}
              </span>
            </div>
            <div className="flex justify-between">
      ...
      <div className="mt-4 bg-blue-900/20 border border-blue-500/30 rounded-lg p-3">
        <h4 className="text-sm font-semibold text-blue-400 mb-2">💡 Tips de Optimización</h4>
        <ul className="text-xs text-slate-300 space-y-1">
          ...
          <li>• Los componentes se cargan bajo demanda para mejor performance</li>
        </ul>
      </div>
    </div>
  );
