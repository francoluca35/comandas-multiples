              ...
              >
                <button
                  ...
                  className={`${getStatusColor(
                    mesa.estado
                  )} text-white rounded-xl p-2 sm:p-3 text-center transition-all duration-300 shadow-lg hover:shadow-xl border border-white/10 hover:border-white/30 w-full aspect-square flex flex-col items-center justify-center transform hover:scale-102 gap-0.5`}
                >
                  <div className="text-base sm:text-lg font-bold drop-shadow-lg">
                    {mesa.numero}
                  </div>
                  <div className="text-[10px] sm:text-xs opacity-90 font-medium drop-shadow-md">
                    {getStatusText(mesa.estado)}
                  </div>
                  <div className="text-[8px] sm:text-[10px] opacity-75 font-medium drop-shadow-sm truncate max-w-full px-1">
                ...
                {(mesa.estado === "ocupado" || mesa.estado === "servido" || mesa.estado === "pagado") && (
                  <button
                    ...
                    className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-orange-500 hover:bg-orange-600 text-white text-[10px] sm:text-xs p-1 sm:p-1.5 rounded-full transition-all duration-200 transform hover:scale-110 shadow-lg z-20 border border-white/80"
