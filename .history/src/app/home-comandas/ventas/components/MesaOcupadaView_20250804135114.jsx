    ...
    <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="flex-1 p-6">
        <div className="bg-gray-800 rounded-lg p-6 mb-6">
          <h2 className="text-white font-bold text-lg mb-4">Detalles del Pedido</h2>
          <div className="space-y-4">
            ...
            <div className="flex justify-between text-white">
              ...
              <span className="font-bold">${orderData.monto}</span>
            </div>
          </div>
        </div>
        ...
        {/* Order Items */}
        <div className="bg-gray-800 rounded-lg p-6 mb-6">
          <h3 className="text-white font-bold text-lg mb-4">Items del Pedido</h3>
