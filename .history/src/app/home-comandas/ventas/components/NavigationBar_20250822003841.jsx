...
function NavigationBar({
  ...
  return (
    <div className="bg-[#2a2a2a] p-3 sm:p-4 lg:p-6 flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0 shadow-lg">
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        {modes.map((mode) => (
          <button
            ...
            className={`px-3 sm:px-4 lg:px-6 py-2 sm:py-3 rounded-xl flex items-center space-x-2 sm:space-x-3 transition-all duration-200 shadow-md ${
              activeMode === mode.id
          ...
          >
            ...
            <span className="font-semibold text-sm sm:text-base lg:text-lg">{mode.name}</span>
          </button>
        ))}
      </div>
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <>
            {filters.map((filter) => (
              <button
                ...
                className={`px-3 sm:px-4 lg:px-6 py-2 sm:py-3 rounded-xl transition-all duration-200 text-sm sm:text-base lg:text-lg font-medium shadow-md ${
        ...
        {currentActions.map((action) => (
          <button
            ...
            className="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 rounded-xl bg-[#3a3a3a] text-white hover:bg-[#4a4a4a] transition-all duration-200 flex items-center space-x-2 sm:space-x-3 shadow-md hover:shadow-lg"
          >
            <div className="w-5 h-5 sm:w-6 sm:h-6">
              {getIcon(action.icon)}
            </div>
            {action.name && <span className="text-sm sm:text-base lg:text-lg font-medium">{action.name}</span>}
          </button>
        ))}
      </div>
    </div>
