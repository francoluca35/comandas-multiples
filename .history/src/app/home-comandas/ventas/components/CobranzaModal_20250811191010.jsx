...
function CobranzaModal({ isOpen, onClose, orderData, onPaymentComplete }) {
  ...
  const handleCobrar = async () => {
    ...
    try {
      // Imprimir ticket antes de procesar el pago
      ...
      switch (selectedPaymentMethod.id) {
        ...
        case "tarjeta":
          ...
          try {
            ...
            const result = await processPayment(orderData, selectedPaymentMethod);
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            <span className="underline">
              {isGenerating ? "Imprimiendo..." : "Cobrar"}
            </span>
          </button>
        </div>
      </div>
