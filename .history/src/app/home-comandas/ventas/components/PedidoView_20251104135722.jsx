  ...
  return (
    ...
    <div className="h-full flex flex-col p-2 sm:p-3">
      ...
      <div className="mt-auto space-y-2">
        ...
        {/* Botones adicionales cuando hay items en el pedido (en fila) */}
        {orderItems.length > 0 && (
          <div className="flex gap-2">
            {/* Botón ver items */}
            <button
              onClick={() => setShowOrderDetails(true)}
              className="flex-1 bg-[#D98C00] hover:bg-[#C77A00] text-white rounded-xl px-3 py-2 items-center justify-center space-x-2 font-bold text-sm transition-all duration-200 transform hover:scale-105 shadow-xl flex"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex-1 bg-[#00A884] hover:bg-[#009673] text-white rounded-xl px-3 py-2 items-center justify-center space-x-2 font-bold text-sm transition-all duration-200 transform hover:scale-105 shadow-xl flex"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
