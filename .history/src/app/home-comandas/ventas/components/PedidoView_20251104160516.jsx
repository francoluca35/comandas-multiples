            ...
            <div className="bg-white rounded-lg w-full max-w-md max-h-[80vh] overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-4">
                {selectedProducts.length === 0 ? (
                  <div className="text-center text-gray-500 py-8">No hay productos en el pedido</div>
                ) : (
                    ...
                    {selectedProducts.map((product) => (
                      <div key={product.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button onClick={() => handleRemoveProduct(product.id)} className="text-red-500 hover:text-red-700 ml-2">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <button onClick={() => handleUpdateQuantity(product.id, product.cantidad - 1)} className="bg-gray-200 hover:bg-gray-300 rounded-full w-8 h-8 flex items-center justify-center font-bold">-</button>
                            <span className="font-bold text-lg min-w-[2rem] text-center">{product.cantidad}</span>
                            <button onClick={() => handleUpdateQuantity(product.id, product.cantidad + 1)} className="bg-gray-200 hover:bg-gray-300 rounded-full w-8 h-8 flex items-center justify-center font-bold">+</button>
                          </div>
                          <div className="font-bold text-green-600">${product.total.toFixed(2)}</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="bg-gray-100 p-4 border-t border-gray-200">
                ...
                <button onClick={() => setShowItemsModal(false)} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-semibold">Cerrar</button>
              </div>
            </div>
          </div>
        )}
