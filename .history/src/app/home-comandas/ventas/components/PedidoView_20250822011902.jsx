  ...
  const handleTerminar = async () => {
    ...
    try {
      ...
      try {
        ...
        return; // No continuar si falla el envío a cocina
      }
      ...
      try {
        ...
        await updateDoc(mesaRef, {
          ...
          total: orderTotal,
          updatedAt: new Date(),
          pedidoId: docRef?.id || "sin-id", // Referencia al pedido de cocina
        });
      ...
      <div className="flex-shrink-0 bg-gradient-to-r from-slate-800 to-slate-700 border-t border-slate-600/50 shadow-xl">
        <div className="p-2 sm:p-3 md:p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3">
            ...
            {/* Botón Enviar a Cocina - Solo cuando hay items */}
            {orderItems.length > 0 && (
              <button
                onClick={handleTerminar}
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-xl font-bold text-sm sm:text-base transition-all duration-200 transform hover:scale-105 shadow-xl flex items-center justify-center space-x-2"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-4 sm:p-6 border-t border-slate-700/50 bg-gradient-to-r from-slate-700 to-slate-800 rounded-b-xl">
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-bold transition-all duration-200 transform hover:scale-105 shadow-lg text-sm flex items-center justify-center space-x-2"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                  </svg>
