  ...
  const handlePaymentComplete = async (paymentMethod, orderData) => {
    try {
      ...
      const pedidoCocina = {
        ...
        tipo: "delivery", // Agregar tipo para diferenciar
        metodoPago: paymentMethod, // Agregar método de pago
      };

      console.log("📋 Datos del pedido delivery para cocina:", pedidoCocina);
      ...
      console.error("❌ Error al enviar pedido delivery a cocina:", error);
