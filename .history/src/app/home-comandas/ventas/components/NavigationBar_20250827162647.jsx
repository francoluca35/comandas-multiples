...
function NavigationBar({
  ...
  const actions = [
    ...
    { id: "historial", name: "Historial de Pedidos", icon: "clock" },
          ...
          <>
            {filters.map((filter) => (
              <button
                ...
                className={`px-2 sm:px-3 md:px-4 lg:px-6 py-1 sm:py-2 md:py-3 rounded-xl transition-all duration-200 text-xs sm:text-sm md:text-base lg:text-lg font-medium shadow-md whitespace-nowrap ${
