        ...
        <div className="p-3 md:p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Botones de Acción cuando hay items */}
              {orderItems.length > 0 && (
                <>
                  <button
                    onClick={() => setShowOrderDetails(true)}
                    className="bg-[#D98C00] hover:bg-[#C77A00] text-white px-4 py-2 rounded-lg font-bold transition-all shadow-lg"
                  >
                    ver items
                  </button>
                  <button
                    onClick={handleTerminar}
                    className="bg-[#00A884] hover:bg-[#009673] text-white px-4 py-2 rounded-lg font-bold transition-all shadow-lg"
                  >
                    enviar a cocina
                  </button>
                </>
