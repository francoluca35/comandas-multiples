...
function TakeawayView({ onBack }) {
  ...
  const handlePaymentComplete = async (paymentMethod, orderData) => {
    try {
      console.log("🚀 Pago completado, enviando pedido a cocina...");
      ...
      const pedidoCocina = {
        mesa: "TAKEAWAY", // Identificador especial para takeaway
        ...
        tipo: "takeaway", // Agregar tipo para diferenciar
        metodoPago: paymentMethod, // Agregar método de pago
      };

      console.log("📋 Datos del pedido takeaway para cocina:", pedidoCocina);

      // Enviar pedido a cocina usando la API
      ...
      console.log("✅ Pedido takeaway enviado a cocina exitosamente:", result);

      // Mostrar notificación de éxito
      alert(`✅ Pedido takeaway procesado exitosamente!\n\nCliente: ${orderData.cliente}\nItems: ${orderData.productos.length}\nTotal: $${orderData.total.toLocaleString()}\nMétodo de pago: ${paymentMethod}\n\nID del pedido: ${result.id}`);
      ...
      console.error("❌ Error al enviar pedido takeaway a cocina:", error);
