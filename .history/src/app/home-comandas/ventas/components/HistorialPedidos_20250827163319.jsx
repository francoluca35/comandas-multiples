...
function HistorialPedidos({ onClose }) {
  ...
  const [filtroTipo, setFiltroTipo] = useState("takeaway"); // "todos", "salon", "takeaway"
  ...
  const filtrarPedidos = () => {
    ...
    // Por defecto, solo mostrar takeaway
    return pedidos.filter(pedido => pedido.mesa === "TAKEAWAY" || pedido.tipo === "takeaway");
  };
      ...
      <div className="bg-slate-800 rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
              ...
              <div className="bg-blue-500 p-2 rounded-lg">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                             ...
                             <div>
                 <h2 className="text-white text-2xl font-bold">Historial de Pedidos Takeaway</h2>
                 <p className="text-slate-300 text-sm">Pedidos takeaway entregados por cocina</p>
               </div>
            </div>
            <button
              onClick={onClose}
            ...
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                 ...
                 {/* Información de pedidos takeaway */}
         <div className="bg-slate-700 p-4 border-b border-slate-600">
           <div className="flex items-center justify-between">
             <div className="flex items-center space-x-3">
               ...
               <span className="text-white font-medium">Pedidos Takeaway Completados</span>
             </div>
             <div className="bg-orange-500 text-white px-3 py-1 rounded-full text-sm font-bold">
               {pedidos.filter(p => p.mesa === "TAKEAWAY" || p.tipo === "takeaway").length}
             </div>
           </div>
         </div>
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-200px)]">
             ...
             <div className="p-8 text-center">
               ...
               <h3 className="text-white text-xl font-bold mb-2">No hay pedidos takeaway en el historial</h3>
               <p className="text-slate-400">
                 Aún no se han completado pedidos takeaway
               </p>
             </div>
          ) : (
            <div className="p-6 space-y-4">
                 ...
                 <div
                   key={pedido.id}
                   className="bg-slate-700 rounded-xl p-6 border-l-4 border-orange-500"
                 >
                   {/* Header del pedido */}
