...
function PedidoView({ mesa, onBack, onMesaOcupada }) {
  ...
  return (
    <div className="h-screen max-h-screen min-h-screen flex flex-col bg-[#1A2036] overflow-hidden">
      ...
      {orderItems.length > 0 && (
        <div className="md:hidden fixed inset-x-0 bottom-0 z-50 bg-[#1A2036] border-t border-slate-700/50 shadow-xl">
          <div className="p-4">
            {/* Total del pedido */}
            <div className="mb-2">
              <div className="text-white text-sm font-medium mb-1">Total del pedido: ${orderTotal.toLocaleString()}</div>
              <button className="text-blue-400 text-xs hover:text-blue-300 underline">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => setShowOrderDetails(true)}
                className="flex-1 bg-[#D98C00] hover:bg-[#C77A00] text-white rounded-lg px-4 py-3 font-bold transition-all"
              >
                ver pedido
              </button>
              <button
                onClick={handleTerminar}
                className="flex-1 bg-[#00A884] hover:bg-[#009673] text-white rounded-lg px-4 py-3 font-bold transition-all"
              >
                enviar a cocina
              </button>
            </div>
      ...
      {/* Espacio para la barra fija en mobile */}
      {orderItems.length > 0 && (
