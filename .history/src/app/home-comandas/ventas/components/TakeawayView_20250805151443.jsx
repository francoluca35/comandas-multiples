...
function TakeawayView({ onBack }) {
  ...
  return (
    <div className="h-full bg-slate-900 flex">
      ...
      <div className="w-1/2 bg-slate-800 border-r border-slate-700">
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 p-6 flex flex-col">
            <h2 className="text-xl font-bold text-white mb-4">Pedido</h2>
            <div className="flex-1 bg-slate-700 rounded-lg p-4 overflow-hidden">
            ...
            <button
              ...
              className="mt-4 w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors"
            >
              Procesar Pedido
            </button>
          </div>
