...
function TakeawayView({ onBack }) {
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      console.log("🚀 Iniciando proceso de envío de pedido takeaway a cocina...");
      console.log("Items en el pedido:", selectedProducts);
      console.log("Total del pedido:", calculateTotal());
      ...
      alert(`✅ Pedido takeaway enviado a cocina exitosamente!\n\nCliente: ${clientData.nombre}\nItems: ${selectedProducts.length}\nTotal: $${calculateTotal().toLocaleString()}\n\nID del pedido: ${result.id}`);
