                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <button
                              ...
                              className="bg-gray-800 hover:bg-gray-600 rounded-full w-8 h-8 flex items-center justify-center font-bold"
                            >
                              -
                            </button>
                            <span className="text-black font-bold text-lg min-w-[2rem] text-center">
                              {product.cantidad}
                            </span>
                            <button
                              onClick={() =>
      ...
      <div className="bg-slate-800 text-white p-4 sticky top-0 z-30 shadow-lg">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-bold text-lg">Mesa {mesa?.numero || "Nueva"}</div>
              <div className="text-sm text-emerald-400">Nuevo pedido</div>
            </div>
          </div>
          <button
            onClick={() => setShowClientModal(true)}
        ...
        <div className="overflow-x-auto pb-2 -mx-4 px-4 flex items-center space-x-2 scrollbar-none">
          <button
            onClick={() => {
              setSelectedMainCategory("todos");
              setSelectedSubCategory("");
