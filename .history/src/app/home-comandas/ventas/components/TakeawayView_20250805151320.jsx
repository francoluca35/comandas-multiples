    ...
    <div className="h-full flex flex-col bg-slate-900 overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/2 bg-slate-800 flex flex-col overflow-hidden">
          <div className="p-6 flex flex-col h-full overflow-y-auto">
            ...
            <div className="flex-1 flex flex-col min-h-0">
              <h2 className="text-2xl font-bold text-white mb-4 flex-shrink-0">Pedido</h2>
              <div className="bg-slate-700 rounded-lg p-4 flex-1 overflow-hidden">
                {selectedProducts.length === 0 ? (
                  <div className="text-gray-400 text-center py-8 h-full flex items-center justify-center">
                  ...
                  <div className="space-y-3 h-full overflow-y-auto">
                    {selectedProducts.map((product) => (
                      <div
                        key={product.id}
                        className="flex items-center justify-between bg-slate-600 rounded-lg p-3 flex-shrink-0"
                      >
            ...
            <button
              ...
              className="mt-6 w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors flex-shrink-0"
            >
              Procesar Pedido
            </button>
          </div>
        ...
        <div className="w-1/2 bg-slate-900 flex flex-col overflow-hidden">
          <div className="p-6 flex flex-col h-full overflow-y-auto">
            <h2 className="text-2xl font-bold text-white mb-6 flex-shrink-0">Menú</h2>
