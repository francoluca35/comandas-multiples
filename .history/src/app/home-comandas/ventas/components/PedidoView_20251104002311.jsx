  ...
  <div className="w-full lg:w-1/3 bg-gradient-to-br from-slate-800 to-slate-900 lg:border-r border-slate-700/50 overflow-y-auto">
    {selectedProduct ? (
      <div className="h-full flex flex-col p-2 sm:p-3">
        ...
        <button onClick={handleAddToOrder} className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-xl px-3 py-2 flex items-center justify-center space-x-2 font-bold text-sm transition-all duration-200 transform hover:scale-105 shadow-xl">
          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
          </svg>
      ...
      <div className="h-full flex items-center justify-center p-2">
        <div className="text-center">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-xl">
            <svg className="w-6 h-6 sm:w-8 sm:h-8 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
          <h3 className="text-white text-base sm:text-lg font-bold mb-1">Selecciona un Producto</h3>
          <p className="text-slate-400 text-xs sm:text-sm">Haz clic en cualquier producto para ver sus detalles</p>
        </div>
      </div>
    )}
  </div>
