...
function VentasPage() {
  ...
  const handleMesaClick = (mesa, onMesaOcupada) => {
  ...
  const handleMesaOcupada = (numeroMesa) => {
    ...
    // Esta función se pasará al PedidoView para marcar la mesa como ocupada
  };
  ...
  const renderContent = () => {
    switch (currentView) {
      case "mesas":
        return (
          <MesasView onMesaClick={handleMesaClick} activeMode={activeMode} />
        );
      case "pedido":
        return (
          <PedidoView 
