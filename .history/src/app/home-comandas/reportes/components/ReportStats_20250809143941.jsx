  ...
  return (
    <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700/50 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <div key={stat.name} className="bg-slate-700/30 rounded-lg p-4 border border-slate-600/30">
            ...
            <div className="mt-4 flex items-center">
              ...
              <span className="text-sm text-slate-400 ml-2">vs mes anterior</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="mt-6 p-4 bg-slate-700/20 rounded-lg border border-slate-600/30">
        ...
        <div className="flex items-center justify-between text-sm mt-2">
          ...
          <span className="text-white font-medium">Reporte de Ventas (Excel)</span>
        </div>
      </div>
    </div>
  );
