  ...
  const generateReport = async () => {
    ...
    try {
      ...
      switch (selectedFormat) {
        case "excel":
          result = await generateExcelReport(selectedReport.id, dateRange, filters);
          break;
        case "csv":
          result = await generateCSVReport(selectedReport.id, dateRange, filters);
          break;
        case "pdf":
          result = await generatePDFReport(selectedReport.id, dateRange, filters);
          break;
        default:
          result = await generateExcelReport(selectedReport.id, dateRange, filters);
      }
