  ...
  return (
    <div className="flex h-screen bg-slate-900 overflow-hidden">
      ...
      >
        ...
        <div className="bg-slate-800/50 border-b border-slate-700/50 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400 text-sm">Administra bebidas y materia prima</p>
            </div>
        ...
        {/* Estadísticas accesibles desde el botón "Estadísticas" */}
        <div className="px-6 py-2">
          <div className="text-sm text-slate-400">Resumen rápido disponible en el botón <span className="font-semibold text-slate-200">Estadísticas</span> arriba.</div>
        </div>
