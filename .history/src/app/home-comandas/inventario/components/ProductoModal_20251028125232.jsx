...
export default function ProductoModal({
  ...
  const validateForm = () => {
    ...
    // Validar checkbox para materia prima - Solo Stock
    if (formData.tipo === "alimento") {
      if (!formData.esStock) {
        newErrors.checkboxes =
          "Debes seleccionar Stock para materia prima";
      }
    }
  ...
  const handleInputChange = (field, value) => {
    setFormData((prev) => {
      ...
      // Si se selecciona "alimento", automáticamente marcar esStock y desmarcar esComida
      if (field === "tipo" && value === "alimento") {
        newData.esStock = true;
        newData.esComida = false;
      }
    ...
    // Limpiar error de checkboxes si se selecciona Stock
    if (field === "esStock" && errors.checkboxes) {
      ...
      <div className="relative top-20 mx-auto p-8 border border-slate-700/50 w-full max-w-md shadow-2xl rounded-2xl bg-slate-800/90 backdrop-blur-sm">
        <div className="mt-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Checkbox para Materia Prima - Solo Stock */}
            {formData.tipo === "alimento" && (
              <div>
                <label className="block text-sm font-semibold text-slate-300 mb-3">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl border transition-all duration-300 flex items-center justify-center gap-2 ${
                      formData.esStock
                ...
                <p className="text-slate-400 text-sm mt-2 text-center">
                  La materia prima se gestiona únicamente como stock
                </p>
                {errors.checkboxes && (
