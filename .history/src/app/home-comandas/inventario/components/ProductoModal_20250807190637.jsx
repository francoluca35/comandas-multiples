             ...
             {formData.tipo === "bebida" && (
               <div>
                 ...
                 <div className="grid grid-cols-2 gap-3">
                   <button
                     type="button"
                     onClick={() => handleInputChange("subcategoria", "sin alcohol")}
                     className={`px-4 py-3 rounded-xl border transition-all duration-300 ${
                   ...
                   <button
                     type="button"
                     onClick={() => handleInputChange("subcategoria", "con alcohol")}
                     className={`px-4 py-3 rounded-xl border transition-all duration-300 ${
                 ...
                 {errors.subcategoria && (
                   <p className="text-red-400 text-sm mt-2">{errors.subcategoria}</p>
                 )}
               </div>
             )}
