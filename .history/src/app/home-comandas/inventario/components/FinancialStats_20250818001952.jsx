    ...
    <div className="bg-slate-700 rounded-lg p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-800 p-3 rounded-lg">
          ...
          <div className="text-xs text-slate-400">Con inventario</div>
        </div>
      </div>
        ...
        <div className="bg-slate-800 p-3 rounded-lg">
          ...
          <div className="space-y-1 text-xs">
            ...
            <div className="flex justify-between">
              ...
              >
                {costoStock > 0
                  ? ((ganancia / costoStock) * 100).toFixed(1)
                  : 0}
                %
              </span>
            </div>
        ...
        <div className="bg-slate-800 p-3 rounded-lg">
          ...
          <div className="space-y-1 text-xs">
            ...
            <div className="flex justify-between">
              ...
              <span
                className={`font-semibold ${
                  (itemsConStock / totalItems) * 100 >= 80
                    ? "text-green-400"
                    : (itemsConStock / totalItems) * 100 >= 60
                    ? "text-yellow-400"
                    : "text-red-400"
                }`}
              >
                {totalItems > 0
                  ? ((itemsConStock / totalItems) * 100).toFixed(1)
                  : 0}
                %
              </span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-red-300 text-xs">
                  Considera revisar precios o costos
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="text-yellow-400 font-semibold text-sm">
                  Muchos items sin stock
                </div>
                <div className="text-yellow-300 text-xs">
                  Considera reabastecer inventario
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-green-300 text-xs">
                  Excelente margen y disponibilidad
                </div>
              </div>
            </div>
          </div>
