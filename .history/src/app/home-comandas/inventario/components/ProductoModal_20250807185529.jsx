          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-3 bg-slate-700/50 border rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-white backdrop-blur-sm ${
            ...
            <div className="flex space-x-4 pt-6">
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    {producto ? <FaEdit className="w-4 h-4" /> : <FaSave className="w-4 h-4" />}
