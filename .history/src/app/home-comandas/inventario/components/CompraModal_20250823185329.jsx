...
import { FaShoppingCart, FaTimes, FaCheck, FaSave } from "react-icons/fa";

const CompraModal = ({ isOpen, onClose, onSave, categorias }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.nombre || !formData.cantidad || !formData.precioUnitario || !formData.categoria) {
      ...
      const compraData = {
        ...
        precioFinal: formData.esConsumoFinal ? Number(formData.precioFinal) : 0,
