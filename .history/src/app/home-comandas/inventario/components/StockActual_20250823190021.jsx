    ...
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6 shadow-2xl shadow-slate-900/50">
        ...
        <div className="bg-slate-700/50 rounded-xl p-4 border border-slate-600/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white font-medium">Stock Total</span>
            </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        ...
        <button 
          ...
          className="bg-blue-600 text-white font-medium py-2 px-3 rounded-lg hover:bg-blue-700 transition-all duration-300 flex items-center justify-center space-x-2"
        >
          <svg
            className="w-4 h-4"
            fill="none"
      ...
      <button 
        ...
        className="w-full bg-slate-600 text-white font-medium py-3 px-4 rounded-xl hover:bg-slate-700 transition-all duration-300 flex items-center justify-center space-x-2"
      >
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      {showHistorial && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 max-w-6xl w-full max-h-[90vh] overflow-y-auto">
