    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-slate-800 rounded-xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          <h3 className="text-lg font-semibold text-white">Estadísticas del Inventario</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-4">
          <div className="bg-slate-700/50 rounded-lg p-4">
            ...
            <p className="text-xs text-slate-400 mt-1">Cantidad × Precio de venta</p>
          </div>
          ...
          <div className="bg-slate-700/50 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-orange-400">{formatCurrency(stats.costoStock)}</p>
          ...
          <div className="bg-slate-700/50 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-green-400">{formatCurrency(stats.ganancia)}</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-slate-700/50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-orange-400">{stats.stockBajo}</p>
            </div>
