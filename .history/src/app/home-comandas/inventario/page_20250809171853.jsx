...
function InventarioContent() {
    ...
    .filter((producto) => {
      ...
      if (tipoFilter !== "Todas") {
        if (tipoFilter === "Bebidas") {
          matchesTipo = producto.tipo === "bebida";
        } else if (tipoFilter === "Comidas") {
          // Para comidas, considerar productos que NO son bebidas
          matchesTipo = producto.tipo !== "bebida";
        }
      }
  ...
  useEffect(() => {
    ...
    console.log(
      "📋 Productos mostrados:",
      filteredProductos.map((p) => p.nombre)
    );
  }, [tipoFilter, selectedCategoria, searchTerm, filteredProductos]);
            ...
            <div className="flex justify-center">
              <div className="flex bg-slate-800/50 border border-slate-700/50 rounded-lg p-1">
                {["Todas", "Bebidas", "Comidas"].map((tipo) => {
                  ...
                  const count = productos.filter((producto) => {
                    if (tipo === "Todas") return true;
                    if (tipo === "Bebidas") return producto.tipo === "bebida";
                    if (tipo === "Comidas") return producto.tipo !== "bebida";
                    return true;
                  }).length;
          ...
          <div className="min-h-screen bg-slate-900 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-slate-500 text-sm">
                Solo los administradores pueden gestionar el inventario del restaurante.
              </p>
            </div>
          </div>
        }
