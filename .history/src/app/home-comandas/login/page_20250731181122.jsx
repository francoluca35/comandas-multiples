  ...
  return (
    <div className="min-h-screen bg-black flex justify-center p-4">
      <div className="bg-[#1c1c1c] h-full p-6 rounded-lg shadow-lg w-[400px] text-white">
        ...
        <div className="bg-[#2e2e2e] p-3 rounded justify-center flex flex-wrap gap-2 justify-start mb-4">
          {usuarios.map((user) => (
            <button
              key={user.id}
              className={`rounded justify-center px-3 py-1 font-semibold flex items-center gap-2 ${
