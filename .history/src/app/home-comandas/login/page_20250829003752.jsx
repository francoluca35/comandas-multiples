...
function Login() {
  ...
  return (
    ...
    >
      ...
      {/* Panel principal */}
      <div className="relative z-10 bg-violet-800/50 bg-opacity-90 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white border-opacity-20 w-full max-w-md">
        {/* Título */}
