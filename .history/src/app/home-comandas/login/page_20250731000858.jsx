...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex  justify-center p-4">
      <div className="bg-[#1c1c1c] h-10 p-6 rounded-lg shadow-lg w-[400px] text-white">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="bg-[#c084fc] text-black font-semibold px-4 py-2 rounded flex items-center gap-1">
            <FaSyncAlt />
            Refrescar
          </button>
        </div>
