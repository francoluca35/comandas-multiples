...
function AddTableModal({
  ...
  const handleSubmit = async (e) => {
    ...
    // Verificar si necesitamos lógica inteligente para números secuenciales
    const lastNumberInLocation = getLastTableNumberInLocation(targetLocation);
  ...
  const handleIntelligentOption = async (option) => {
    try {
      if (option === "create-multiple") {
        ...
        await reorderTablesForLocation(startNumber, endNumber, otherLocation, targetLocation);
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-700/50 rounded-lg p-4 space-y-3">
                ...
                {intelligentOptions.existingTableInOtherLocation ? (
                  <>
                    <button
                      onClick={() => handleIntelligentOption("move-all-up-to")}
                    ...
                    >
                      <div className="font-semibold text-blue-400">
                        Opción 1: Mover {intelligentOptions.tablesToMove} mesas hasta la {intelligentOptions.targetNumber}
                      </div>
                      <div className="text-sm text-slate-300 mt-1">
                        Mover las mesas {intelligentOptions.lastNumberInLocation + 1} hasta {intelligentOptions.targetNumber} de {intelligentOptions.otherLocation === "adentro" ? "Adentro" : "Afuera"} a {intelligentOptions.targetLocation === "adentro" ? "Adentro" : "Afuera"}
                      </div>
                    </button>

                    <button
                      onClick={() => handleIntelligentOption("move-specific")}
                    ...
                    >
                      <div className="font-semibold text-orange-400">
                        Opción 2: Mover solo la mesa {intelligentOptions.targetNumber}
                      </div>
                      <div className="text-sm text-slate-300 mt-1">
                        Mover únicamente la mesa {intelligentOptions.targetNumber} de {intelligentOptions.otherLocation === "adentro" ? "Adentro" : "Afuera"} a {intelligentOptions.targetLocation === "adentro" ? "Adentro" : "Afuera"} y reordenar las restantes
                      </div>
                    </button>
                  </>
                ) : (
