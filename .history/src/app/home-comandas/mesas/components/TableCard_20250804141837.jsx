    ...
    <div className="group relative bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300 overflow-hidden hover:shadow-2xl hover:shadow-slate-900/50">
      ...
      <div className="relative z-10">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <div className={`absolute -top-1 -right-1 w-4 h-4 rounded-full ${getStatusDot(table.estado)} shadow-lg animate-pulse`}></div>
              </div>
              <div>
            ...
            <div className={`px-3 py-1 rounded-full text-xs font-semibold border backdrop-blur-sm ${getStatusColor(table.estado)}`}>
              {getStatusText(table.estado)}
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm font-medium text-slate-400">Productos:</span>
            <span className="text-sm text-white font-semibold">
