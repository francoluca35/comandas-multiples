  ...
  const handleIntelligentOption = async (option) => {
    try {
      if (option === "create-multiple") {
        ...
        await updateTable(intelligentOptions.existingTableInOtherLocation.id, {
          lugar: intelligentOptions.targetLocation,
        });
        ...
        for (let i = 0; i < otherLocationTables.length; i++) {
          ...
          const newTableNumber = String(
            parseInt(table.numero) + 1
          ).padStart(2, "0");
          await updateTable(table.id, { numero: newTableNumber });
        }

        alert(
          `Se movió la mesa ${intelligentOptions.targetNumber} de ${intelligentOptions.otherLocation} a ${intelligentOptions.targetLocation} y se reordenaron las mesas de ${intelligentOptions.otherLocation}`
        );
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-700/50 rounded-lg p-4 space-y-3">
                ...
                {intelligentOptions.existingTableInOtherLocation ? (
                  <>
                    <button
                      onClick={() => handleIntelligentOption("move-and-reorder")}
                    ...
                    >
                      <div className="font-semibold text-blue-400">
                        Opción 1: Crear mesa {intelligentOptions.targetNumber} en {intelligentOptions.targetLocation === "adentro" ? "Adentro" : "Afuera"}
                      </div>
                      <div className="text-sm text-slate-300 mt-1">
                        Crear la mesa {intelligentOptions.targetNumber} en{" "}
                        {intelligentOptions.targetLocation === "adentro" ? "Adentro" : "Afuera"} y reordenar las mesas de {intelligentOptions.otherLocation === "adentro" ? "Adentro" : "Afuera"}
                      </div>
                    </button>

                    <button
                      onClick={() => handleIntelligentOption("create-next")}
                    ...
                    >
                      <div className="font-semibold text-orange-400">
                        Opción 2: Crear mesa {intelligentOptions.nextNumberInOtherLocation} en {intelligentOptions.otherLocation === "adentro" ? "Adentro" : "Afuera"}
                      </div>
                      <div className="text-sm text-slate-300 mt-1">
                        Crear la mesa {intelligentOptions.nextNumberInOtherLocation} en{" "}
                        {intelligentOptions.otherLocation === "adentro" ? "Adentro" : "Afuera"} (siguiente número disponible)
                      </div>
                    </button>
                  </>
                ) : (
                  <>
                    ...
                    >
                      ...
                      <div className="text-sm text-slate-300 mt-1">
                        ...
                        {intelligentOptions.targetLocation === "adentro"
                          ? "Adentro"
                          : "Afuera"}{" "}
                        hasta la mesa {intelligentOptions.targetNumber} y reordenar
                        las mesas de{" "}
                    ...
                    >
                      ...
                      <div className="text-sm text-slate-300 mt-1">
                        Crear la mesa {intelligentOptions.lastNumberInLocation + 1} en{" "}
                        {intelligentOptions.targetLocation === "adentro"
                          ? "Adentro"
                          : "Afuera"}{" "}
                        y reordenar las mesas restantes hasta la {intelligentOptions.targetNumber}
                      </div>
                    </button>
                  </>
                )}
