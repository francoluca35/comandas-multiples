              ...
              <div className="bg-slate-700/50 rounded-lg p-4 space-y-3">
                ...
                >
                  ...
                  <div className="text-sm text-slate-300 mt-1">
                    Crear {intelligentOptions.missingTables} mesas adicionales en{" "}
                    {intelligentOptions.targetLocation === "adentro" ? "Adentro" : "Afuera"} hasta la mesa {intelligentOptions.targetNumber} y reordenar las mesas de {intelligentOptions.otherLocation === "adentro" ? "Adentro" : "Afuera"}
                  </div>
                </button>
