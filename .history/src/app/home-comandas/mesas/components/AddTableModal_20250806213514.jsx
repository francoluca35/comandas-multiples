  ...
  const handleIntelligentOption = async (option) => {
    try {
      if (option === "add-to-opposite") {
        ...
        // Mostrar prompt para especificar cantidad
        ...
        if (quantity && !isNaN(quantity) && parseInt(quantity) > 0) {
          const startNumber = getLastTableNumberInLocation(intelligentOptions.targetLocation) + 1;
          const endNumber = startNumber + parseInt(quantity) - 1;
        ...
        const otherLocation = intelligentOptions.targetLocation === "adentro" ? "afuera" : "adentro";
        ...
        for (let i = 0; i < remainingTablesInLocation.length; i++) {
          ...
          const newTableNumber = String(nextTableNumber + i + 1).padStart(2, "0");
          await updateTable(table.id, { numero: newTableNumber });
        }
        ...
        alert(
          `Se creó la mesa ${nextTableNumber} en ${
            intelligentOptions.targetLocation === "adentro" ? "Adentro" : "Afuera"
          } y se reordenaron las mesas restantes hasta la ${intelligentOptions.targetNumber}`
        );
      }
