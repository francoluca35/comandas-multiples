...
function AddTableModal({
  ...
  const handleQuantitySubmit = async () => {
    try {
      ...
      const lastNumberInTargetLocation = getLastTableNumberInLocation(intelligentOptions.targetLocation);
      ...
      // Crear las mesas faltantes hasta llegar al número objetivo
      ...
      // Reordenar las mesas de la otra ubicación para que empiecen después del número objetivo
      for (let i = 0; i < otherLocationTables.length; i++) {
        const table = otherLocationTables[i];
      ...
      const tablesCreated = endNumber - startNumber + 1;
      alert(
        `Se crearon ${tablesCreated} mesas en ${
