...
function MesasManagement() {
  ...
  const handleLiberarMesa = async (table) => {
    if (
      !confirm(
        `¿Estás seguro de que quieres liberar manualmente la Mesa ${table.numero}? Esta acción la marcará como disponible y eliminará todos los datos del pedido.`
      )
    ) {
      return;
    }
    ...
    try {
      // Actualizar la mesa para liberarla
      ...
      console.log(`Mesa ${table.numero} liberada manualmente`);
      alert(`Mesa ${table.numero} liberada exitosamente`);
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
        <div className="max-w-7xl mx-auto">
          ...
          {error && (
            <div className="mx-4 sm:mx-8 mt-4 sm:mt-6 mb-4 bg-red-500/10 border border-red-500/20 rounded-xl p-4 backdrop-blur-sm">
          ...
          {loading && (
            <div className="flex items-center justify-center px-4 py-12 sm:py-20">
              <div className="text-center">
                <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-4 border-slate-600 border-t-blue-500 mx-auto"></div>
                <p className="text-slate-300 mt-4 sm:mt-6 text-base sm:text-lg font-medium">
                  Cargando mesas...
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <p className="text-slate-300 text-sm">
                  ...
                  <span className="font-semibold text-blue-400">
                    {reorganizeOptions.deletedTable.lugar === "adentro"
                      ? "Adentro"
                      : "Afuera"}
                  </span>
                ...
                <div className="bg-slate-700/50 rounded-lg p-4 space-y-3">
                  ...
                  >
                    ...
                    <div className="text-sm text-slate-300 mt-1">
                      Mantener las mesas con sus números actuales (
                      {reorganizeOptions.adentroCount} adentro,{" "}
                      {reorganizeOptions.afueraCount} afuera)
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-sm text-slate-300 mt-1">
                      Reordenar todas las mesas para que tengan números
                      secuenciales (1, 2, 3...)
                    </div>
                  </button>
                </div>
