...
function AddTableModal({
  ...
  const handleSubmit = async (e) => {
    ...
    if (existingTableInOtherLocation) {
      ...
      const nextNumberInOtherLocation = getLastTableNumberInLocation(otherLocation) + 1;
    ...
    // Solo mostrar opciones inteligentes si el número específico ya existe en la otra ubicación
    const otherLocation = targetLocation === "adentro" ? "afuera" : "adentro";
    const existingTableInOtherLocation = tables.find(
      (table) => table.numero === formData.numero && table.lugar === otherLocation
    );
                  ...
                  <>
                    ...
                    >
                      <div className="font-semibold text-blue-400">
                        Opción 1: Mover {intelligentOptions.tablesToMove} mesas
                        hasta la {intelligentOptions.targetNumber}
                      </div>
                      <div className="text-sm text-slate-300 mt-1">
                        Mover las mesas{" "}
                        {intelligentOptions.lastNumberInLocation + 1} hasta{" "}
                        {intelligentOptions.targetNumber} de{" "}
                        {intelligentOptions.otherLocation === "adentro"
                          ? "Adentro"
                          : "Afuera"}{" "}
                        a{" "}
                    ...
                    >
                      <div className="font-semibold text-orange-400">
                        Opción 2: Mover solo la mesa{" "}
                        {intelligentOptions.targetNumber}
                      </div>
                      <div className="text-sm text-slate-300 mt-1">
                        Mover únicamente la mesa{" "}
                        {intelligentOptions.targetNumber} de{" "}
                        {intelligentOptions.otherLocation === "adentro"
                          ? "Adentro"
                          : "Afuera"}{" "}
