  ...
  const handleIntelligentOption = async (option) => {
    try {
      if (option === "create-multiple") {
        ...
        const targetTableNumber = String(
        ...
        if (!tableToMove) {
          alert(
            `No se encontró la mesa ${intelligentOptions.targetNumber} en ${
        ...
        const lastNumberInTarget = getLastTableNumberInLocation(
          intelligentOptions.targetLocation
        );
