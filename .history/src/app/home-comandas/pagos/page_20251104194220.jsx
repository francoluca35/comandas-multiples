    ...
    <div className="flex h-screen bg-slate-900 overflow-hidden">
      ...
      <div
        className={`flex-1 flex flex-col bg-slate-800 transition-all duration-300 ${
          isExpanded
            ? "ml-0 sm:ml-64 md:ml-72 lg:ml-80 xl:ml-96 2xl:ml-[420px]"
            : "ml-0 sm:ml-16"
        }`}
      >
        {/* Header */}
        ...
        <div className="flex-1 overflow-auto bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 sm:ml-0 ml-3 py-4 sm:py-6">
            <div className="flex flex-col sm:ml-0 xl:ml-0 ml-10 gap-6 sm:gap-8">
