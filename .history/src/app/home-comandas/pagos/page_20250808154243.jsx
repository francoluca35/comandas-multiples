               ...
               <div className="flex flex-col items-center">
                 <div className="flex items-center gap-4 mb-4">
                   ...
                   <button
                     ...
                     title={sections.dineroActual ? "Ocultar sección" : "Mostrar sección"}
                   >
                     <svg
               ...
               <div className="flex flex-col items-center">
                 <div className="flex items-center gap-4 mb-4">
                   ...
                   <button
                     ...
                     className="p-2 bg-slate-700/50 hover:bg-slate-600/50 rounded-lg transition-colors"
                     title={sections.egresos ? "Ocultar sección" : "Mostrar sección"}
                   >
                     <svg
                       className={`w-5 h-5 text-white transition-transform duration-300 ${
               ...
               <div className="flex flex-col items-center">
                 <div className="flex items-center gap-4 mb-4">
                   ...
                   <button
                     ...
                     className="p-2 bg-slate-700/50 hover:bg-slate-600/50 rounded-lg transition-colors"
                     title={sections.ingresos ? "Ocultar sección" : "Mostrar sección"}
                   >
                     <svg
                       className={`w-5 h-5 text-white transition-transform duration-300 ${
               ...
               <div className="flex flex-col items-center">
                 <div className="flex items-center gap-4 mb-4">
                   ...
                   <button
                     ...
                     className="p-2 bg-slate-700/50 hover:bg-slate-600/50 rounded-lg transition-colors"
                     title={sections.rendimiento ? "Ocultar sección" : "Mostrar sección"}
                   >
                     <svg
                       className={`w-5 h-5 text-white transition-transform duration-300 ${
