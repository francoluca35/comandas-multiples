...
`}
      >
        ...
        {/* Main Content */}
        <div className="flex-1 sm:ml-0 ml-2 overflow-auto bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
          <div className="w-auto sm:ml-0 ml-10   sm:max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
