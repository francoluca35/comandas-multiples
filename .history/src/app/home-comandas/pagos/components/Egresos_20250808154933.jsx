      ...
      {isExpanded && (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-xs text-slate-400">5 productos</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-lg font-bold text-purple-400">
            {formatDinero(
              getEfectivoTotal() + getVirtualTotal() - getTotalAlivios()
            )}
          </span>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className="w-5 h-5 bg-red-500/20 rounded-sm flex items-center justify-center">
                <svg
