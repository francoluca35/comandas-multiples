    ...
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6 shadow-2xl shadow-slate-900/50">
      ...
      <div className="bg-slate-700/50 rounded-xl p-4 border border-slate-600/50 mb-6">
        ...
        <div className="space-y-2">
          {/* Caja */}
          <div className="flex items-center justify-between bg-slate-600/30 rounded-lg p-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-300 text-sm font-medium">caja</span>
            </div>
          ...
          <div className="flex items-center justify-between bg-slate-600/30 rounded-lg p-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-300 text-sm font-medium">virtual</span>
            </div>
