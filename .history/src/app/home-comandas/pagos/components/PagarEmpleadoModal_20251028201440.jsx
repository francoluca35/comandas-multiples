...
function PagarEmpleadoModal({ isOpen, onClose, onSuccess, data, formatDinero }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-slate-800 rounded-2xl p-6 w-full max-w-2xl shadow-2xl">
        {/* Header */}
            ...
            <div className="space-y-2">
              ...
              <div className="border-t border-slate-600 pt-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-xl font-bold text-yellow-400">{formatDinero(calculos.totalGeneral)}</span>
                </div>
              </div>
            </div>
          </div>
