    ...
    <div className="space-y-6">
      ...
      {statistics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Total de Pagos</h3>
            <p className="text-2xl font-bold text-gray-900">{statistics.totalPayments}</p>
          </div>
          
          <div className="bg-white p-4 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Pagos Aprobados</h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <p className="text-2xl font-bold text-purple-600">{statistics.approvalRate.toFixed(1)}%</p>
          </div>
        </div>
      )}
                    ...
                    <div className="flex-shrink-0">
                      <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                        <span className="text-blue-600 font-medium">
                          {payment.paymentMethod?.charAt(0)?.toUpperCase() || 'P'}
                        </span>
                      </div>
                    </div>
      ...
      {statistics && (
        <div className="bg-gray-50 p-4 rounded-lg">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Resumen Financiero</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div>
              <span className="text-gray-500">Total recibido por restaurante:</span>
            ...
            <div>
              ...
              <span className="ml-2 font-medium text-gray-900">
                {statistics.totalAmount > 0 ? ((statistics.totalPlatformFees / statistics.totalAmount) * 100).toFixed(1) : 0}%
              </span>
            </div>
          </div>
        </div>
