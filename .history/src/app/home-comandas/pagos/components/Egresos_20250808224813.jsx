      ...
      {isExpanded && (
        <>
          ...
          <div className="flex justify-center mb-4">
            <button className="w-full max-w-md bg-slate-600 text-white font-medium py-2 px-3 rounded-lg hover:bg-slate-700 transition-all duration-300 flex items-center justify-center space-x-2">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
