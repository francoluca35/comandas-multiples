...
export default function AlivioModal({ isOpen, onClose, onSuccess }) {
  ...
  // Obtener sugerencias de servicios existentes
  ...
  }, [formData.nombreServicio, nombresServicios]);
      ...
      <div className="bg-slate-800 rounded-2xl border border-slate-700/50 p-6 w-full max-w-md shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="bg-slate-700/50 border border-slate-600/50 rounded-lg px-4 py-3 text-slate-400">
