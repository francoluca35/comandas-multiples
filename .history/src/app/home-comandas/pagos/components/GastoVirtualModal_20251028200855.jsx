...
function GastoVirtualModal({ isOpen, onClose, onSuccess, data, formatDinero }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const egresoData = {
        ...
        motivo: formData.motivo || "Gasto virtual",
        tipo: "gasto_virtual",
        formaPago: "virtual",
        restauranteId,
      ...
      // Actualizar el dinero actual (descontar del virtual)
      const dineroActualRef = doc(db, "DineroActual", restauranteId);
      await updateDoc(dineroActualRef, {
        virtual: virtualDisponible - monto,
      ...
      console.error("❌ Error al registrar gasto virtual:", err);
      ...
      <div className="bg-slate-800 rounded-2xl p-6 w-full max-w-md shadow-2xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-white">Gasto Virtual</h2>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Dinero Virtual Disponible */}
        <div className="bg-slate-700/50 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-between">
            <span className="text-slate-300 text-sm">Dinero Virtual Disponible:</span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="Ej: Compra de insumos online"
              className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center space-x-2"
            >
              {isLoading ? (
                <>
...
export default GastoVirtualModal;
