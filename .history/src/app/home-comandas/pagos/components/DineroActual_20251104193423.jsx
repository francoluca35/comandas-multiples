          ...
          <div className="bg-gradient-to-r from-purple-600/20 to-purple-800/20 border border-purple-500/30 rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xl font-bold text-purple-400">
                {formatDinero(
                  resumenIngresos.ingresoEfectivo +
                    resumenIngresos.ingresoVirtual
                )}
              </span>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-700/50 mt-4">
            <div className="flex">
              <button
                ...
                className="w-full sm:w-auto bg-blue-500 text-white font-medium py-2 px-6 rounded-lg hover:bg-blue-600 transition-all duration-300 flex items-center justify-center space-x-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
