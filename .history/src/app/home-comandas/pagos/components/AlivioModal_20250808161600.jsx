  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const alivioData = {
        ...
        tipodepago: showPaymentOptions
          ? `${formData.tipodepago} - ${selectedPaymentOption}`
          : formData.tipodepago,
      };

      await crearAlivio(alivioData);
      onSuccess();
      onClose();
    } catch (error) {
      setError("Error al crear el alivio: " + error.message);
    }
  };
