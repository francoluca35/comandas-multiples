...
function Rendimiento() {
  ...
  const ingresosTotales =
    getEfectivoTotal() + getVirtualTotal() + getTotalIngresos();
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-4 shadow-2xl shadow-slate-900/50">
      ...
      <div className="bg-slate-700/50 rounded-lg p-3 border border-slate-600/50 mb-4">
        ...
        <div className="text-xs text-slate-400 mt-1">Alivios + Compras</div>
      </div>
      ...
      <div className="bg-slate-700/50 rounded-lg p-3 border border-slate-600/50 mb-4">
        ...
        <div className="text-xs text-slate-400 mt-1">Admin + Ingresos</div>
      </div>

      {/* Rendimiento (Ganancia/Pérdida) */}
      <div
        className={`${rendimientoBgColor} rounded-lg p-3 border border-slate-600/50 mb-4`}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div
        ...
        <div className="text-xs text-slate-400 mt-1">Ingresos - Egresos</div>
      </div>
