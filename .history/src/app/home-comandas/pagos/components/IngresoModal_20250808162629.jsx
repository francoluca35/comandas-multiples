...
export default function IngresoModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Determinar si es efectivo o virtual basado en la forma de ingreso
      const esEfectivo = formData.formaIngreso === "Efectivo";
      
      const ingresoData = {
        ...formData,
        monto: parseFloat(formData.monto),
        esEfectivo: esEfectivo, // Agregar flag para identificar el tipo
        tipoCuenta: esEfectivo ? "efectivo" : "virtual" // Especificar el tipo de cuenta
      };
