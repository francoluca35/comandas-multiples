      ...
      {isExpanded && (
        <>
          ...
          <div className="text-xs text-slate-400 mb-4">
            Ingresos Registrados (incluye ventas)
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-2">
            <div className="flex items-start sm:items-center space-x-2">
              <div
                className={`w-6 h-6 ${rendimientoBgColor} rounded-md flex items-center justify-center`}
              >
                <svg
          ...
          <div className="space-y-1 mb-3">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs">
              <span className="text-slate-300">• Egresos Totales:</span>
              <span className="text-red-400 font-medium mt-1 sm:mt-0">
                {formatDinero(egresosTotales)}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-1">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs">
              ...
              <span className="text-green-400 font-medium mt-1 sm:mt-0">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs border-t border-slate-600 pt-1 mt-1">
              <span className="text-slate-300 font-semibold">
                • Total Ingresos:
              </span>
              <span className="text-green-400 font-bold mt-1 sm:mt-0">
