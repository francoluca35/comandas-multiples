      ...
      {isExpanded && (
        <>
          ...
          <div className="flex justify-center mb-4">
            <button className="bg-slate-600 text-white font-medium py-2 px-2 rounded-lg hover:bg-slate-700 transition-all duration-300 flex items-center justify-center space-x-1">
              <svg
                className="w-3 h-3"
                fill="none"
                stroke="currentColor"
              ...
              <span className="text-xs">Historial de egresos</span>
            </button>
          </div>
        </>
      )}
