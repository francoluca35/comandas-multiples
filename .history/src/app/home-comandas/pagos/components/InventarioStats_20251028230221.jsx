    ...
    return (
      <div className="bg-slate-800/50 rounded-2xl border border-slate-700/50 p-6 shadow-2xl shadow-slate-900/50">
        <div className="flex items-center justify-center">
          ...
          <span className="ml-3 text-white">Cargando estadísticas de inventario...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-white">Estadísticas de Inventario</h2>
          </div>
          <p className="text-sm font-bold text-white mt-2">Ganancias estimadas en cuanto stock tengamos</p>
        </div>
        <button
          onClick={onToggle}
