...
function Rendimiento({ onToggle, isExpanded, data, formatDinero, getEfectivoTotal, getVirtualTotal, getTotalIngresos, getTotalEgresos, getVentasEfectivo, getVentasVirtual }) {
  ...
  // El dinero actual ES la suma de las ventas (efectivo + virtual) menos los egresos
  const dineroActualTotal = ventasTotales - egresosTotales;
  
  // Los ingresos totales en rendimiento deben mostrar el dinero actual (ventas - egresos)
  const ingresosReales = dineroActualTotal;
  
  // Calcular rendimiento (dinero actual - egresos ya descontados, así que es solo el dinero actual)
  const rendimiento = dineroActualTotal;
