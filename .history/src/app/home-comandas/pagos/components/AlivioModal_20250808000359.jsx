...
export default function AlivioModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleInputChange = (e) => {
    ...
    // Si cambia el tipo de pago, mostrar opciones correspondientes
    if (name === "tipodepago") {
      if (
        value === "Efectivo" ||
        value === "Transferencia" ||
                 ...
                 <div className="space-y-2">
                   ...
                   >
                     <div className="flex items-center space-x-2">
                       ...
                       <span className="font-medium">Usar efectivo de la caja</span>
                     </div>
                     <p className="text-xs text-slate-400 mt-1">
                       Se descontará de la caja registradora
                     </p>
                   </button>
                 </div>
               ) : (
                 <div className="space-y-2">
                   ...
                   >
                     <div className="flex items-center space-x-2">
                       ...
                       <span className="font-medium">Pagar con otra cuenta</span>
                     </div>
                     <p className="text-xs text-slate-400 mt-1">
                   ...
                   <button
                     type="button"
                     onClick={() => setSelectedPaymentOption("cuenta_restaurante")}
                     className={`w-full text-left p-3 rounded-lg border transition-all ${
                   ...
                   >
                     <div className="flex items-center space-x-2">
                       ...
                       <span className="font-medium">Pagar desde cuenta del restaurante</span>
                     </div>
                     <p className="text-xs text-slate-400 mt-1">
                       Se descontará del dinero virtual
                     </p>
                   </button>
                 </div>
               )}
