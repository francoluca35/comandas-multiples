...
function Egresos({ onToggle, isExpanded }) {
  ...
  // Los valores ya vienen memoizados del hook usePagosData
  const { fetchAlivios } = useAlivios();
  const { fetchSueldos } = useSueldos();
  const { fetchInversionTotal } = useInversionTotal();
