...
import MargenesInventario from "./components/MargenesInventario";
        ...
        <div className="flex-1 overflow-auto bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex flex-col gap-8">
              ...
              {/* Márgenes de Inventario Section */}
              <div className="w-full">
                <MargenesInventario
                  onToggle={() => toggleSection("margenesInventario")}
                  isExpanded={sections.margenesInventario}
                  formatDinero={formatDinero}
                />
              </div>
