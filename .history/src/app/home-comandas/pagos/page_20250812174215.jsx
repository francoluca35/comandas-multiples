...
import FinanzasDebug from "../../../components/FinanzasDebug";
                ...
                <div className="bg-slate-800/50 rounded-2xl border border-slate-700/50 p-6 shadow-2xl shadow-slate-900/50">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <h2 className="text-xl font-bold text-white">Debug Finanzas</h2>
                    </div>
                    <button
                      onClick={() => toggleSection("debug")}
                      className="p-2 bg-slate-700/50 hover:bg-slate-600/50 rounded-lg transition-colors"
                      title={sections.debug ? "Ocultar sección" : "Mostrar sección"}
                    >
                      <svg
