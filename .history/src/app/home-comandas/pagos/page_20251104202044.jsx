...
function PagosContent() {
  ...
  return (
    <div className="flex h-screen bg-slate-900 overflow-hidden">
      ...
      {/* opcional: overlay solo si querés bloquear clicks en mobile cuando el sidebar esté abierto */}
      {isExpanded && (
        <div
      ...
      {/* MAIN: dejamos que el main tenga margin-left igual al ancho del sidebar
      - cuando está expandido: ml-56 (mobile), sm:ml-64, md:ml-72...
      - cuando está colapsado: ml-16 (mobile), sm:ml-20
  */}
      <div
    ...
    `}
      >
        ...
        <div className="flex-1 overflow-auto bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
          <div className="w-auto sm:max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
