...
function PreLogin() {
  ...
  const mostrarAlerta = ({ title, text, icon = "success" }) => {
    return MySwal.fire({
      ...
      customClass: {
        popup: "rounded-3xl shadow-2xl border border-white border-opacity-10",
        title: "text-2xl font-bold text-white mb-2",
        content: "text-white text-lg",
        confirmButton: "rounded-xl px-8 py-3 font-semibold text-black transition-all duration-300 hover:scale-105 shadow-lg",
        icon: "text-6xl mb-4"
      },
      ...
      imageHeight: 80,
      imageAlt: "Logo",
      imageClass: "rounded-full shadow-lg mb-4",
