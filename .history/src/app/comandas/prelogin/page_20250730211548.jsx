...
function PreLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const subcolRef = collection(db, "codigosactivacion", cod);
      ...
      for (const docSnap of docs.docs) {
        ...
        if (data.email === email && data.password === password) {
          ...
          alert(
            `Bienvenido ${data.resto.toUpperCase()}.\nUsuarios permitidos: ${
              data.cantUsuarios
            }`
          );

          // Aquí podés guardar datos en localStorage si querés
      ...
      if (!accesoValido) {
        ...
        alert("Email, contraseña o código inválidos.");
      }
    } catch (error) {
