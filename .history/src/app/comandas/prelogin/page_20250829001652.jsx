...
function PreLogin() {
  ...
  const mostrarAlerta = ({ title, text, icon = "success" }) => {
    return MySwal.fire({
      ...
      customClass: {
        popup: "rounded-2xl shadow-xl border border-white border-opacity-20",
        title: "text-lg font-bold text-white mb-1",
        content: "text-white text-sm",
        confirmButton: "rounded-lg px-6 py-2 font-semibold text-black transition-all duration-300 hover:scale-105",
        icon: "text-4xl mb-2"
      },
      ...
      imageHeight: 50,
      imageAlt: "Logo",
      imageClass: "rounded-full shadow-md mb-2",
