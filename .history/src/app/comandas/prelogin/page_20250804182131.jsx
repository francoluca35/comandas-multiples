    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        if (data.email === email && data.password === password) {
          ...
          console.log("Buscando restaurante con:", {
            nombre: data.resto,
            codigoActivacion: cod,
          });

          restaurantesSnapshot.forEach((doc) => {
            const restauranteData = doc.data();
            console.log("Revisando documento:", {
              id: doc.id,
              nombre: restauranteData.nombre,
              codigoActivacion: restauranteData.codigoActivacion,
            });

            if (
              restauranteData.nombre === data.resto &&
              restauranteData.codigoActivacion === cod
            ) {
          ...
          mostrarAlerta({
            ...
            if (restauranteId) {
              ...
              console.log("✅ RestauranteId guardado en localStorage:", restauranteId);
            } else {
              console.error("❌ No se pudo guardar restauranteId - es null o vacío");
