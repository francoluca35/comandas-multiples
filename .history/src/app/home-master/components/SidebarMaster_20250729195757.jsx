          ...
          {opciones.map((op) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-4 text-amber-300 w-full px-3 py-2 rounded-lg transition-colors duration-200
                  ${
                    activo
                      ? "bg-black text-white"
        ...
        {/* <div className={abierto ? "px-3" : "flex justify-center"}>
          <button
            ...
            className={`flex items-center gap-3 w-full  transition-colors duration-200
              text-white/80 hover:bg-red-600 hover:text-red-800
              ${abierto ? "justify-center " : "justify-center"}
            `}
          >
