    ...
    >
      <div className="flex flex-col justify-between h-full py-6 mt-10">
        ...
        <div
          ...
          } flex-1 gap-10 `} // <= Aquí reducimos el gap
        >
          {opciones.map((op) => {
            ...
            return (
              <button
                ...
                className={`flex mt-10 items-center gap-4 w-full transition-all duration-200 ${
                  abierto
                    ? "justify-start hover:bg-black hover:text-white px-3 py-1.5 rounded" // <= Aquí también ajustamos py
                    : "justify-center"
                }`}
              >
                <IconComponent size={abierto ? 22 : 32} />
                {abierto && (
        ...
        <div className={abierto ? "px-3" : "flex justify-center"}>
          ...
          >
            <FaSignOutAlt size={abierto ? 22 : 32} />
