    ...
    >
      ...
      <div className="mb-4">
        <button
          ...
          className={`flex hover:text-red-500 items-center gap-3 h-10 px-3 rounded-l-full text-white hover:bg-red-600 w-full
            ${abierto ? "justify-start" : "justify-center"}
          `}
        >
          <FaPowerOff size={18} className="hover:text-red-500" />
          {abierto && <span className="text-sm hover:text-red-500">Salir</span>}
        </button>
      </div>
    </div>
  );
