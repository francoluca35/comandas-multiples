      ...
      <div className="flex flex-col justify-between h-full py-6">
          ...
          {opciones.map((op) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-4 w-full px-3 py-2 rounded-md transition-colors duration-200
                  ${
                    activo
        ...
        <div className={abierto ? "px-3" : "flex justify-center"}>
          <button
            ...
            className={`flex items-center gap-3 w-full px-3 py-2 rounded-md transition-colors duration-200
