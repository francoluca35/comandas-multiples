          ...
          {stats.memory ? (
            <div className="space-y-4">
              ...
              <div className="pt-2 border-t border-slate-700">
                ...
                <div className="text-xs text-slate-500 mt-1">
                  {memoryUsagePercentage < 50 ? "Uso óptimo" :
                   memoryUsagePercentage < 80 ? "Uso moderado" : "Uso crítico"}
                </div>
              </div>
            </div>
          ) : (
            <p className="text-slate-400">Información de memoria no disponible</p>
          )}
        </div>
          ...
          {memoryUsagePercentage > 80 && (
            <div className="p-3 bg-red-900/20 border border-red-500/30 rounded-lg">
              ...
              <div className="text-red-300 text-xs">
                La memoria está al {memoryUsagePercentage.toFixed(1)}%. Considera reiniciar la aplicación.
              </div>
            </div>
          )}
