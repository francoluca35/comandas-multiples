...
export default function MetricsPage() {
  ...
  const handleDeleteMetrics = async () => {
    if (confirm("¿Estás seguro de que quieres eliminar completamente la colección metrics? Esta acción no se puede deshacer.")) {
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex space-x-3">
              ...
              >
                {loading ? "Eliminando..." : "Eliminar Colección"}
              </button>
            </div>
          </div>
