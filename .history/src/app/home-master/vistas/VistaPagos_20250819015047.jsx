        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-800 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="mt-6 pt-6 border-t border-gray-700">
              ...
              {/* Acciones de Pago */}
              <div className="mb-4">
                <h5 className="text-sm font-medium text-gray-400 mb-2">Gestión de Pagos</h5>
              ...
              {/* Acciones de Estado */}
              <div className="mb-4">
                <h5 className="text-sm font-medium text-gray-400 mb-2">Gestión de Estado</h5>
                <div className="flex flex-wrap gap-2">
                  {selectedRestaurant.estado === "suspendido" ? (
                    <button
                      onClick={() => handleEnableRestaurant(selectedRestaurant.id)}
                      disabled={actionLoading}
                    ...
                    <button
                      onClick={() => handleSuspendRestaurant(selectedRestaurant.id)}
                      disabled={actionLoading}
              ...
              <div>
                <h5 className="text-sm font-medium text-gray-400 mb-2">Acciones Destructivas</h5>
                <div className="flex flex-wrap gap-2">
                  <button
