...
const FormCheckbox = React.memo(({ 
  ...
  <div className="flex items-start space-x-3">
    <input
      ...
      onChange={onChange}
      className="
        w-5 h-5 mt-1 rounded border-slate-600/50
    ...
    <div className="flex-1">
      <label htmlFor={name} className="text-sm font-semibold text-slate-200 cursor-pointer">
        {label}
      </label>
      {description && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  min={1}
                  max={100}
                  className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-xl text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all duration-200"
                />
                {errors.cantidadUsuarios && (
                  <p className="text-sm text-red-400">{errors.cantidadUsuarios.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    placeholder="ABC123"
                    className="flex-1 px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-xl text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all duration-200"
                  />
                  <Button
                    type="button"
                    variant="secondary"
                ...
                {errors.codigoActivacion && (
                  <p className="text-sm text-red-400">{errors.codigoActivacion.message}</p>
                )}
              </div>
            </div>
