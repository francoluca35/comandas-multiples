  ...
  ({
    ...
    <div className="space-y-2">
      ...
      <input
        ...
        step={step}
        className={`
        w-full px-3 py-2.5 bg-slate-800/50 border rounded-lg
  ...
  ({ label, name, checked, onChange, description }) => (
    <div className="flex items-start space-x-3">
      <input
        ...
        onChange={onChange}
        className="
        w-4 h-4 mt-1 rounded border-slate-600/50
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-shrink-0 p-4 border-b border-slate-700/50 bg-slate-800/30">
        <div className="text-center">
          <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg shadow-blue-500/25">
            <svg
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    min={1}
                    max={100}
                    className="w-full px-3 py-2.5 bg-slate-800/50 border border-slate-600/50 rounded-lg text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all duration-200 text-sm"
                  />
                  {errors.cantidadUsuarios && (
                    <p className="text-xs text-red-400">{errors.cantidadUsuarios.message}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      placeholder="ABC123"
                      className="flex-1 px-3 py-2.5 bg-slate-800/50 border border-slate-600/50 rounded-lg text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all duration-200 text-sm"
                    />
                    <Button
                      type="button"
                      variant="secondary"
                  ...
                  {errors.codigoActivacion && (
                    <p className="text-xs text-red-400">{errors.codigoActivacion.message}</p>
                  )}
                </div>
              </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <ul className="text-xs text-slate-400 space-y-0.5">
                  ...
                  <li>• Los usuarios podrán registrarse usando el código de activación</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div className="flex-shrink-0 p-4 border-t border-slate-700/50 bg-slate-800/30">
        <div className="flex flex-col sm:flex-row gap-3 justify-end max-w-2xl mx-auto">
          <Button
            type="button"
            variant="secondary"
