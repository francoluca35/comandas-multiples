...
export default function VistaRestaurantes() {
  ...
  const handleAnalyzeIssue = async (restaurantId, issue) => {
    ...
    try {
      ...
      // Si la resolución fue exitosa, re-escanear el restaurante
      if (result.success) {
        setTimeout(() => {
          scanAllRestaurants();
        }, 2000);
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="mt-3">
                            <button
                              onClick={() => handleAnalyzeIssue(selectedRestaurant.id, issue)}
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="flex-1">
                        <h5 className={`font-medium ${
                          analysisResult.success ? "text-green-400" : "text-red-400"
                        }`}>
