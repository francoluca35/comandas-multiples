  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      ...
      <div className="text-center mb-6">
        <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg shadow-blue-500/25"></div>
