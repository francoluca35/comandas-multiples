...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      console.log("🔍 AuthContext - Path detection:", {
        currentPath,
        isSuperAdminSystem,
        isRestaurantSystem,
      });
    ...
    localStorage.setItem = function(key, value) {
      ...
      if (key === "usuario" || key === "rol" || key === "restauranteId") {
        console.log("🔄 localStorage.setItem detectado, re-ejecutando checkAuth");
    ...
    localStorage.removeItem = function(key) {
      ...
      if (key === "usuario" || key === "rol" || key === "restauranteId") {
        console.log("🔄 localStorage.removeItem detectado, re-ejecutando checkAuth");
