...
export const RoleProvider = ({ children }) => {
  ...
  console.log("🔐 RoleProvider - Datos recibidos:", { usuario, rol });

  const permissions = useMemo(() => {
    if (!rol) {
      console.log("❌ RoleProvider - No hay rol disponible");
      return {};
    }
  ...
  console.log("🔐 RoleProvider - Valor del contexto:", value);
