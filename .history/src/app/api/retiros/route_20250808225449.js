...
export async function GET(request) {
  try {
    ...
    console.log("🔍 API Retiros - Obteniendo retiros para restaurante:", restauranteId);
    ...
    try {
      ...
      console.log("ℹ️ Colección CajaRegistradora no existe aún, retornando array vacío");
      return NextResponse.json({
        success: true,
        data: [],
    ...
    console.log("✅ Retiros obtenidos exitosamente:", {
      ...
      totalRetiros: retiros.reduce((sum, retiro) => {
        if (retiro.historialRetiros && typeof retiro.historialRetiros === 'object') {
          const retiroTotal = Object.values(retiro.historialRetiros).reduce((retiroSum, pago) => {
