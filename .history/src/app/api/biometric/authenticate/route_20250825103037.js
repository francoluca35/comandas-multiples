...
export async function POST(req) {
  try {
    ...
    // El restauranteId debe venir en el request o obtenerse de otra manera
    // Por ahora, lo obtenemos del header o del body
    const restauranteId = req.headers.get("x-restaurante-id") || req.nextUrl?.searchParams.get("restauranteId");
