...
async function actualizarCajaRegistradoraIngreso(restauranteId, monto, motivo, fecha) {
  try {
...
async function actualizarDineroVirtualIngreso(restauranteId, monto, motivo, fecha) {
  try {
