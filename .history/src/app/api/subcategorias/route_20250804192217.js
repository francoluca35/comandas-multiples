...
export async function GET(request) {
  try {
    ...
    console.log(
      "🔍 API Subcategorías - Obteniendo subcategorías para restaurante:",
      restaurantId
    );
...
export async function POST(request) {
  try {
    ...
    console.log(
      "🔍 API Subcategorías POST - Creando subcategoría para restaurante:",
      restaurantId
    );
    ...
    if (!mainCategoryId || !name || name.trim() === "") {
      return NextResponse.json(
        {
          success: false,
          error: "ID de categoría principal y nombre son obligatorios",
        },
        { status: 400 }
      );
    }
...
export async function PUT(request) {
  try {
    ...
    console.log(
      "🔍 API Subcategorías PUT - Actualizando subcategoría para restaurante:",
      restaurantId
    );
...
export async function DELETE(request) {
  try {
    ...
    console.log("🔍 API Subcategorías DELETE - Eliminando subcategoría para restaurante:", restaurantId);
