...
export async function POST(request) {
  try {
    ...
    const preference = {
      items: [
        {
          title: `${restaurantName} - ${orderData.title || `Mesa ${orderData.mesa}`}`,
      ...
      back_urls: {
        ...
        failure: `${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/pago-error`,
        pending: `${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/pago-exitoso`,
      },
      ...
      additional_info: {
        ...
        order_total: (orderData.unit_price || orderData.monto) * (orderData.quantity || 1),
      },
    };
