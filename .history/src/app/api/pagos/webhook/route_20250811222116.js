...
async function liberarMesa(restaurantId, externalRef) {
  try {
    console.log("🔍 Intentando liberar mesa:", { restaurantId, externalRef });

    // Por ahora, simplemente registramos que se intentó liberar la mesa
    // En una implementación completa, necesitarías buscar la mesa específica
    // basada en el external_reference o en el estado actual

    // Crear un registro de liberación de mesa
