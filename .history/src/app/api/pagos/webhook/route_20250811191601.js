...
export async function POST(request) {
  try {
    ...
    switch (paymentData.status) {
      case 'approved':
        await handleApprovedPayment(paymentData, restaurantId, restaurantName, orderTotal);
        break;
...
async function handleApprovedPayment(paymentData, restaurantId, restaurantName, orderTotal) {
  try {
    ...
    console.log(`Payment approved for restaurant ${restaurantName}: $${restaurantAmount} (Platform fee: $${platformFee})`);
