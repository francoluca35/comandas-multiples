...
export async function POST(request) {
  try {
    ...
    const paymentData = tempPayment.body;
    ...
    switch (finalPaymentData.status) {
      case "approved":
        await handleApprovedPayment(finalPaymentData, restaurantId, restaurantName, orderTotal);
        break;
    ...
    await recordPaymentTransaction(finalPaymentData, restaurantId, restaurantName);
...
async function handleApprovedPayment(paymentData, restaurantId, restaurantName, orderTotal) {
  try {
    ...
    console.log(`Payment approved for restaurant ${restaurantName}: $${restaurantAmount} (Individual account)`);
