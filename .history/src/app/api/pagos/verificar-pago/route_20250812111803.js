...
export async function POST(request) {
  try {
    ...
    console.log("🔍 Verificando pago:", { paymentId, restaurantId, externalReference });
    ...
    if (paymentData.status === "approved") {
      try {
        await liberarMesa(restaurantId, externalReference, paymentData.additional_info);
...
async function liberarMesa(restaurantId, externalRef, additionalInfo) {
  try {
    console.log("🔍 Liberando mesa desde verificación:", { restaurantId, externalRef });
