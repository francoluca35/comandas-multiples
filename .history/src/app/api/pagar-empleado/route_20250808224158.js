...
export async function POST(request) {
  try {
    ...
    try {
      ...
      // Si la colección no existe, continuar con empleadoData vacío
      console.log("ℹ️ Colección SueldoEmpleados no existe aún, creando primer empleado");
    }

    // Agregar el nuevo pago al historial del empleado
    const historialPagos = empleadoExiste
      ? empleadoData.historialPagos || {}
      : {};
