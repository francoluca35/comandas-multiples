...
export async function POST(request) {
  try {
    ...
    const subcategoriaPath = subcategoria === "con alcohol" ? "con_alcohol" : "sin_alcohol";
    const bebidasRef = collection(db, "restaurantes", restauranteId, "menus", "bebidas", "subcategorias", subcategoriaPath, "items");
