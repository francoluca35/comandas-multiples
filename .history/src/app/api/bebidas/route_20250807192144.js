...
export async function GET(request) {
  try {
    ...
    const sinAlcoholRef = collection(db, "restaurantes", restauranteId, "menus", "bebidas", "subcategorias", "sin_alcohol", "items");
    ...
    const conAlcoholRef = collection(db, "restaurantes", restauranteId, "menus", "bebidas", "subcategorias", "con_alcohol", "items");
