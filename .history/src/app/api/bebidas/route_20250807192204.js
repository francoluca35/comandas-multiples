...
export async function PUT(request) {
  try {
    ...
    const sinAlcoholRef = doc(db, "restaurantes", restauranteId, "menus", "bebidas", "subcategorias", "sin_alcohol", "items", bebidaId);
    ...
    if (sinAlcoholDoc.exists()) {
      ...
      const conAlcoholRef = doc(db, "restaurantes", restauranteId, "menus", "bebidas", "subcategorias", "con_alcohol", "items", bebidaId);
