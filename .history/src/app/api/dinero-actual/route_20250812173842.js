...
// Función para inicializar caja registradora y dinero virtual si no existen
async function inicializarEstructurasFinancieras(restauranteId) {
  try {
    console.log("🔧 Inicializando estructuras financieras para:", restauranteId);
    ...
    if (dineroSnapshot.empty) {
      ...
      console.log("✅ Documento de dinero virtual creado");
    }

    console.log("✅ Estructuras financieras inicializadas correctamente");
  } catch (error) {
...
export async function GET(request) {
  try {
    ...
    // Inicializar estructuras financieras si no existen
    await inicializarEstructurasFinancieras(restauranteId);
