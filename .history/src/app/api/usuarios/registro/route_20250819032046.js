...
export async function POST(req) {
  try {
    ...
    const restauranteId = dataCod.restauranteId || generarRestauranteId(nombreRestaurante);
    ...
    console.log("📍 Ruta del usuario:", `restaurantes/${restauranteId}/users/${usuario}`);
    
    await setDoc(
      doc(db, `restaurantes/${restauranteId}/users/${usuario}`),
      {
        nombreCompleto,
        usuario,
        email,
