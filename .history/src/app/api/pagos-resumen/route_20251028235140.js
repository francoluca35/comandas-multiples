...
export async function GET(request) {
  try {
    ...
    // Calcular dinero actual (efectivo) - Apertura de caja + ventas - egresos
    let efectivoTotal = 0;
    let totalCajas = 0;
    let ultimaActualizacion = null;

    // Sumar el efectivo de las cajas (apertura)
    ...
    // Calcular dinero actual real: apertura + ventas + ingresos adicionales - egresos
    // Los ingresos de ventas ya están incluidos en ventasEfectivo/ventasVirtual
    // Solo sumamos ingresos que NO son ventas (ingresos adicionales)
    efectivoTotal = efectivoTotal + ventasEfectivo + ingresosEfectivo - egresosEfectivo;
    virtualTotal = virtualTotal + ventasVirtual + ingresosVirtual - egresosVirtual;
