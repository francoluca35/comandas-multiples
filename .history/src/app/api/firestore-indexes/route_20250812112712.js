  ...
  const indexes = [
    {
      ...
      description: "Índice para consultas de pagos por restaurante y external_reference"
    },
    {
      collection: "payments",
      fields: [
      ...
      queryScope: "COLLECTION",
      description: "Índice para consultas de pagos por restaurante ordenados por fecha"
    }
  ];
