...
export async function GET(request) {
  try {
    ...
    console.log(
      "🔍 API Categorías - Obteniendo categorías para restaurante:",
      restaurantId
    );
...
// POST - Crear nueva categoría principal
export async function POST(request) {
  try {
    ...
    console.log("🔍 API Categorías POST - Creando categoría para restaurante:", restaurantId);
...
export async function PUT(request) {
  try {
    ...
    console.log("🔍 API Categorías PUT - Actualizando categoría para restaurante:", restaurantId);
