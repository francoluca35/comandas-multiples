      ...
      const checkSessionExpiry = () => {
        ...
        if (isRestaurantSystem) {
          ...
          if (!restauranteId || !usuarioLocal) {
            ...
            // Limpiar solo los datos de sesión del restaurante, NO las credenciales biométricas
            const keysToRemove = [
              "usuario",
              "rol", 
              "usuarioId",
            ...
            console.log("🧹 Datos de sesión limpiados, credenciales biométricas preservadas");
