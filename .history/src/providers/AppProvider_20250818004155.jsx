    ...
    if (!loading && usuario) {
      const checkSessionExpiry = () => {
        ...
        if (isRestaurantSystem) {
          ...
          // Para el superadmin, confiamos en que AuthContext ya verificó Firebase Auth
          // No necesitamos verificar localStorage aquí porque AuthContext ya maneja esto
          // El AuthContext verifica Firebase Auth y establece usuario/rol correctamente
          console.log("🔍 Sistema superadmin - AuthContext maneja la autenticación");
        }
...
export const AppProvider = ({ children }) => {
  ...
  React.useEffect(() => {
    // Solo iniciar en el cliente
    if (typeof window !== "undefined") {
      console.log("🚀 Iniciando sistema de métricas global...");
