...
const useKitchenNotifications = () => {
  ...
  const [soundType, setSoundType] = useState("powerful"); // "powerful", "alarm", "simple"
  ...
  const playNotificationSound = useCallback(async () => {
    ...
    try {
      ...
      // Crear un sonido de notificación POTENTE tipo alarma de cocina
      ...
      console.log("🔔 Sonido de notificación POTENTE tipo alarma de cocina reproducido");
