...
export const useProducts = (restaurantId = 'francomputer') => {
  ...
  const fetchProductsByCategory = async (categoryId) => {
    try {
      ...
      const productsRef = collection(db, 'restaurantes', restaurantId, 'menus', categoryId, 'items');
  ...
  const createProduct = async (productData) => {
    try {
      ...
      const { categoryId, name, price, discount = 0, description = '' } = productData;
      ...
      // Crear el producto
      const productRef = collection(db, 'restaurantes', restaurantId, 'menus', categoryId, 'items');
  ...
  const updateProduct = async (productId, categoryId, productData) => {
    try {
      ...
      const { name, price, discount = 0, description = '', activo = true } = productData;
      ...
      const productRef = doc(db, 'restaurantes', restaurantId, 'menus', categoryId, 'items', productId);
