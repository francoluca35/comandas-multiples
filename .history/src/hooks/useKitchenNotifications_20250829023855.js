...
const useKitchenNotifications = () => {
  ...
  // Función para crear sonido de "tururut tutut" tradicional
  const createAlarmSound = (audioContext) => {
    ...
    // Configurar compresor para sonido tradicional
    compressor.threshold.setValueAtTime(-25, audioContext.currentTime);
    ...
    // Configurar filtro para sonido más cálido y tradicional
    filter.type = 'lowpass';
    filter.frequency.setValueAtTime(3000, audioContext.currentTime);
    filter.Q.setValueAtTime(1.2, audioContext.currentTime);
    
    // Configurar osciladores para sonido "tururut tutut"
    oscillator1.type = 'triangle';  // Sonido base más suave
    oscillator2.type = 'sine';      // Sonido melódico
    oscillator3.type = 'triangle';  // Sonido armónico
    
    // Frecuencias para crear el patrón "tururut tutut"
    const baseTime = audioContext.currentTime;
    
    // Primer "tururut" (notas ascendentes)
    oscillator1.frequency.setValueAtTime(600, baseTime);
    oscillator2.frequency.setValueAtTime(800, baseTime);
    oscillator3.frequency.setValueAtTime(1000, baseTime);
    
    // Transición a notas más altas
    oscillator1.frequency.exponentialRampToValueAtTime(800, baseTime + 0.1);
    oscillator2.frequency.exponentialRampToValueAtTime(1000, baseTime + 0.1);
    oscillator3.frequency.exponentialRampToValueAtTime(1200, baseTime + 0.1);
    
    // Pico del "tururut"
    oscillator1.frequency.exponentialRampToValueAtTime(1000, baseTime + 0.2);
    oscillator2.frequency.exponentialRampToValueAtTime(1200, baseTime + 0.2);
    oscillator3.frequency.exponentialRampToValueAtTime(1400, baseTime + 0.2);
    
    // Descenso del "tururut"
    oscillator1.frequency.exponentialRampToValueAtTime(800, baseTime + 0.3);
    oscillator2.frequency.exponentialRampToValueAtTime(1000, baseTime + 0.3);
    oscillator3.frequency.exponentialRampToValueAtTime(1200, baseTime + 0.3);
    
    // Pausa breve
    oscillator1.frequency.exponentialRampToValueAtTime(600, baseTime + 0.4);
    oscillator2.frequency.exponentialRampToValueAtTime(800, baseTime + 0.4);
    oscillator3.frequency.exponentialRampToValueAtTime(1000, baseTime + 0.4);
    
    // Segundo "tutut" (notas más cortas y agudas)
    oscillator1.frequency.exponentialRampToValueAtTime(1000, baseTime + 0.5);
    oscillator2.frequency.exponentialRampToValueAtTime(1200, baseTime + 0.5);
    oscillator3.frequency.exponentialRampToValueAtTime(1400, baseTime + 0.5);
    
    // Final del "tutut"
    oscillator1.frequency.exponentialRampToValueAtTime(800, baseTime + 0.6);
    oscillator2.frequency.exponentialRampToValueAtTime(1000, baseTime + 0.6);
    oscillator3.frequency.exponentialRampToValueAtTime(1200, baseTime + 0.6);
    
    // Configurar volumen con envelope para "tururut tutut"
    gainNode.gain.setValueAtTime(0, baseTime);
    gainNode.gain.linearRampToValueAtTime(volume * 0.7, baseTime + 0.02);
    gainNode.gain.exponentialRampToValueAtTime(volume * 0.8, baseTime + 0.1);
    gainNode.gain.exponentialRampToValueAtTime(volume * 0.9, baseTime + 0.2);
    gainNode.gain.exponentialRampToValueAtTime(volume * 0.6, baseTime + 0.3);
    gainNode.gain.exponentialRampToValueAtTime(volume * 0.3, baseTime + 0.4);
    gainNode.gain.exponentialRampToValueAtTime(volume * 0.8, baseTime + 0.5);
    gainNode.gain.exponentialRampToValueAtTime(volume * 0.5, baseTime + 0.6);
    gainNode.gain.exponentialRampToValueAtTime(0.001, baseTime + 0.7);
    
    // Reproducir el sonido
    oscillator1.start(baseTime);
    oscillator2.start(baseTime);
    oscillator3.start(baseTime);
    oscillator1.stop(baseTime + 0.7);
    oscillator2.stop(baseTime + 0.7);
