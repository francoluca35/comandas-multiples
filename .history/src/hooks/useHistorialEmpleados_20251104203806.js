...
export const useHistorialEmpleados = () => {
  ...
  const registrarInicioSesion = async () => {
    try {
      ...
      const historialRef = collection(db, "restaurantes", restauranteId, "historialEmpleados");
  ...
  const borrarHistorial = async () => {
    try {
      ...
      const promesasBorrado = querySnapshot.docs.map(documento => 
        deleteDoc(doc(db, "restaurantes", restauranteId, "historialEmpleados", documento.id))
      );
