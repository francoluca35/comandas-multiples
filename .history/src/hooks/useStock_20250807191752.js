    ...
    if (productoData.tipo === "bebida") {
      try {
        ...
        if (existingBebida) {
          ...
          console.log(`✅ Bebida "${productoData.nombre}" actualizada en menú bebidas`);
        } else {
          // Crear nueva bebida
          ...
          if (createResponse.ok) {
            console.log(`✅ Bebida "${productoData.nombre}" creada en menú bebidas (${productoData.subcategoria})`);
          } else {
            console.error(`❌ Error creando bebida "${productoData.nombre}" en menú bebidas`);
          }
        }
      } catch (error) {
