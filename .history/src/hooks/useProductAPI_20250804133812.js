...
export const useProductAPI = () => {
  ...
  const fetchSubCategories = async (mainCategoryId, restaurantId = "francomputer") => {
    try {
      setLoading(true);
      setError(null);
  ...
  const createMainCategory = async (name, restaurantId = "francomputer") => {
    try {
      ...
      const data = await handleApiError(response, "Error al crear categoría principal");
      return data.data;
    } catch (err) {
      setError(err.message);
  ...
  const createSubCategory = async (mainCategoryId, name, restaurantId = "francomputer") => {
    try {
      setLoading(true);
      setError(null);
      ...
      const data = await handleApiError(response, "Error al crear subcategoría");
      return data.data;
    } catch (err) {
      setError(err.message);
  ...
  const deleteSubCategory = async (mainCategoryId, name, restaurantId = "francomputer") => {
    try {
      setLoading(true);
      setError(null);
