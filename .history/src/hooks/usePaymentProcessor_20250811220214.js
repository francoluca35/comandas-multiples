  ...
  const processPayment = async (orderData, paymentMethod) => {
    ...
    try {
      ...
      if (paymentMethod === "tarjeta") {
        ...
        // Para QR, retornar los datos sin redirección - USAR PRODUCCIÓN
        console.log("🔄 Processing QR payment method (PRODUCCIÓN)");
        ...
        // USAR PRODUCCIÓN - No más sandbox
        const qrData = {
          ...data,
          initPoint: data.initPoint, // Usar siempre initPoint (producción)
        };

        console.log("✅ Final QR data (PRODUCCIÓN):", {
        ...
        console.log("🚀 Returning QR result (PRODUCCIÓN):", result);
        return result;
      } else {
