...
export const useHistorialEmpleados = () => {
  ...
  // Función para prevenir llamadas múltiples
  const preventMultipleCalls = async (callback) => {
    ...
    try {
      ...
      // Usar un timeout para prevenir llamadas rápidas consecutivas
  ...
  const registrarInicioSesion = async () => {
    return preventMultipleCalls(async () => {
      try {
        ...
        console.log(
          `🔄 Iniciando registro de sesión para usuario ${usuarioId}`
        );
    ...
    const registrarCierreSesion = async () => {
      return preventMultipleCalls(async () => {
        try {
          ...
          console.log(
            `🔄 Iniciando cierre de sesión para usuario ${usuarioId}`
          );
      ...
      const borrarHistorial = async () => {
        try {
          ...
          console.log(
            `Encontrados ${querySnapshot.size} documentos para borrar`
          ); // Para debugging
