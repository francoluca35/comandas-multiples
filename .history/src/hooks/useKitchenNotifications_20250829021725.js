...
const useKitchenNotifications = () => {
  ...
  const playNotificationSound = useCallback(async () => {
    ...
    try {
      ...
      // Crear un sonido de notificación potente y llamativo
      const createNotificationSound = () => {
        ...
        // Configurar compresor para un sonido más potente
        ...
        // Configurar osciladores para un sonido más llamativo
        oscillator1.type = 'square';  // Sonido más agresivo
        oscillator2.type = 'sawtooth'; // Sonido más rico
        oscillator3.type = 'triangle'; // Sonido más suave
        ...
        // Modulación de frecuencia para hacer el sonido más dinámico
        ...
        // Segunda modulación para más variación
        ...
        // Configurar volumen con envelope más agresivo
        gainNode.gain.setValueAtTime(0, audioContext.currentTime);
        gainNode.gain.linearRampToValueAtTime(volume * 0.8, audioContext.currentTime + 0.02); // Más volumen
        gainNode.gain.exponentialRampToValueAtTime(volume * 0.6, audioContext.currentTime + 0.1);
        gainNode.gain.exponentialRampToValueAtTime(volume * 0.4, audioContext.currentTime + 0.2);
        gainNode.gain.exponentialRampToValueAtTime(0.001, audioContext.currentTime + 0.6); // Duración más larga
      ...
      console.log("🔔 Sonido de notificación potente reproducido");
      ...
      try {
        ...
        gainNode.gain.setValueAtTime(0, audioContext.currentTime);
        gainNode.gain.linearRampToValueAtTime(volume * 0.7, audioContext.currentTime + 0.02);
