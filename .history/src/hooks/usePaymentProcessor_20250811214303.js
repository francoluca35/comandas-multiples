  ...
  const processPayment = async (orderData, paymentMethod) => {
    ...
    try {
      ...
      if (paymentMethod === "tarjeta") {
        ...
        console.log("Returning QR data:", { success: true, method: "qr", data });
        return { success: true, method: "qr", data };
      } else {
        // Para pagos en efectivo, no necesitamos redirección
        console.log("Returning efectivo data:", { success: true, method: "efectivo" });
