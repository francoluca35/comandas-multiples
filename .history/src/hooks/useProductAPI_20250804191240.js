...
export const useProductAPI = () => {
  ...
  const getRestaurantId = () => {
    ...
    console.log("🏪 API - Usando restauranteId:", restauranteId);
  ...
  const createSubCategory = async (mainCategoryId, name) => {
    try {
      setLoading(true);
      setError(null);
  ...
  const updateMainCategory = async (oldName, newName) => {
    try {
      setLoading(true);
      setError(null);
  ...
  const updateSubCategory = async (mainCategoryId, oldName, newName) => {
    try {
      setLoading(true);
      setError(null);
  ...
  const deleteSubCategory = async (mainCategoryId, name) => {
    try {
      setLoading(true);
      setError(null);
