...
export default function FinanzasDebug() {
  ...
  const verificarEstado = async (id) => {
    ...
    try {
      const response = await fetch(
        `/api/inicializar-finanzas?restauranteId=${id}`
      );
  ...
  return (
    <div className="bg-gray-100 border border-gray-300 rounded-lg p-4 mb-4">
      ...
      {loading && <div className="text-blue-600 mb-3">⏳ Procesando...</div>}
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              <span
                className={
                  estado.tieneDineroVirtual ? "text-green-600" : "text-red-600"
                }
              >
