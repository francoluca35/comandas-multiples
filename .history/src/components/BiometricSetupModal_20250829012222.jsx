...
const BiometricSetupModal = ({ isOpen, onClose, onSuccess, userId, username, existingCredentials = [], isInitialSetup = false, isPostLoginSetup = false }) => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">
                {isPostLoginSetup 
                  ? "Configurar Huella Digital para Futuros Inicios de Sesión"
                  : isInitialSetup 
                    ? "Configurar Primera Huella Digital" 
              ...
              {!isSupported ? (
                ...
                <div className="space-y-4">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-slate-400">
                      {isPostLoginSetup 
                        ? "Configura tu huella digital para poder iniciar sesión de forma más rápida y segura en el futuro."
