...
function PaymentStatusModal({ isOpen, onClose, paymentId, orderData, onPaymentComplete }) {
      ...
      <div className="bg-white rounded-lg p-8 w-96 max-w-md">
        {isLoading ? (
          ...
          <div className="text-center">
            ...
            {/* Estado */}
            <p className={`text-lg font-semibold ${getStatusColor(paymentStatus.status)} mb-4`}>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold">{orderData?.cliente || "Sin nombre"}</p>
                </div>
                <div>
                  <span className="text-gray-600">Total:</span>
                  <p className="font-semibold">${orderData?.monto?.toLocaleString()}</p>
                </div>
                <div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">No se pudo verificar el estado del pago</p>
            <button
              onClick={onClose}
