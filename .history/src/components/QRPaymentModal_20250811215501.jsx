      ...
      <div className="bg-white rounded-lg p-6 w-96 max-w-[90vw] max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-4 p-3 bg-gray-100 rounded-lg text-xs">
          ...
          <div className="space-y-1">
            <div><strong>isOpen:</strong> {isOpen ? "true" : "false"}</div>
            <div><strong>hasPaymentData:</strong> {paymentData ? "true" : "false"}</div>
            <div><strong>hasInitPoint:</strong> {paymentData?.initPoint ? "true" : "false"}</div>
            <div><strong>initPoint:</strong> {paymentData?.initPoint || "null"}</div>
            <div><strong>isLoading:</strong> {isLoading ? "true" : "false"}</div>
            <div><strong>hasError:</strong> {error ? "true" : "false"}</div>
