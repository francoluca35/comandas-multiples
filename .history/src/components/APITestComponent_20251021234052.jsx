  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-4 p-4 bg-blue-50 rounded-lg">
        <h4 className="font-semibold text-blue-800 mb-2">APIs Configuradas:</h4>
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>• <strong>MockAPI</strong> - API de respaldo que siempre funciona</li>
        </ul>
        <div className="mt-2 p-2 bg-yellow-50 rounded text-sm text-yellow-800">
          <strong>Nota:</strong> Si las APIs externas fallan, se usará MockAPI como respaldo.
        </div>
      </div>
    </div>
  );
