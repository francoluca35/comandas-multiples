  ...
  const confirmarPagoManual = async () => {
    try {
      ...
      if (!restaurantId) {
        ...
        // SOLUCIÓN TEMPORAL: Usar un restauranteId hardcodeado para testing
        console.warn("⚠️ Usando restauranteId hardcodeado para testing");
        restaurantId = "prueba"; // Cambia esto por tu restauranteId real
        
        alert(
          "Usando restauranteId de prueba. Para producción, asegúrate de estar logueado correctamente."
        );
      }
