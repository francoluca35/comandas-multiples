...
function TicketSendModal({ isOpen, onClose, orderData, onSendComplete }) {
  ...
  const handleSendTicket = async () => {
    try {
      ...
      await downloadAndSendTicket(orderData, selectedMethod, emailAddress);
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm opacity-90">Enviar por WhatsApp</div>
                </div>
              </div>
              {selectedMethod === 'whatsapp' && (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm opacity-90">Enviar por email</div>
                </div>
              </div>
              {selectedMethod === 'email' && (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
