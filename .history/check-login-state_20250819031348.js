...
console.log(
  `  - ¿Coinciden?: ${
    restauranteIdGenerado === restauranteIdAlmacenado ? "✅" : "❌"
  }`
);
...
console.log(
  "  2. Verificar en DevTools > Console los logs del RestaurantContext"
);
console.log("  3. Verificar que Firebase esté conectado correctamente");
console.log(
  "  4. Verificar que el documento del restaurante exista en Firebase"
);
