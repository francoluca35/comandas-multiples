...
- **✅ Pedidos Listos**: Se activan cuando se marca un pedido como "listo" (con vibración y sonido 1)
- **📳 Vibración**: Patrón de vibración para dispositivos móviles
- **🎵 Sonido 1**: Reproduce sonido1.mp3 para notificaciones de pedidos listos

#### **Notificaciones de Pedidos Listos**
- **Ubicación**: Barra flotante en la parte superior de la pantalla
- **Duración**: 1 minuto automático
- **Cierre manual**: Botón X para cerrar inmediatamente
- **Sonido**: Reproduce sonido1.mp3 automáticamente
- **Vibración**: Patrón de 3 vibraciones cortas
- **Notificación del navegador**: Si los permisos están habilitados
- **Páginas afectadas**: Dashboard y Ventas
...
- **Barra flotante**: Se desliza desde arriba de la pantalla
- **Diseño responsivo**: Se adapta a diferentes tamaños de pantalla
- **Animaciones**: Efectos de entrada y salida suaves
- **Indicadores visuales**: Puntos animados para mostrar actividad
