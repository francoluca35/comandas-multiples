...
console.log(`  - Coincidencia: ${estructuraEsperada.restaurantes.deamondd.codigoActivacion === mockLocalStorage.codActivacion}`);

console.log("\n📝 Recomendaciones:");
console.log("  1. Verificar que el campo en Firebase se llame 'codigoActivacion'");
