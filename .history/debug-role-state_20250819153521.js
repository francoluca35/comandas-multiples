...
if (localStorageData.nombreResto) {
  const expectedRestauranteId = generarRestauranteId(
    localStorageData.nombreResto
  );
...
if (isRestaurantSystem) {
  ...
  if (
    localStorageData.restauranteId &&
    localStorageData.usuario &&
    localStorageData.rol
  ) {
...
console.log(
  "  - corregirRestauranteId(): Corregir restauranteId si es necesario"
);
